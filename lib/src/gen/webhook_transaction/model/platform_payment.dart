...
abstract class PlatformPayment implements Built<PlatformPayment, PlatformPaymentBuilder> {
  ...
  // enum platformPaymentTypeEnum {  AcquiringFees,  AdyenCommission,  AdyenFees,  AdyenMarkup,  BalanceAccount,  ChargebackRemainder,  Commission,  DCCPlatformCommission,  Default,  Interchange,  PaymentFee,  Remainder,  SchemeFee,  Surcharge,  Tip,  TopUp,  VAT,  };
