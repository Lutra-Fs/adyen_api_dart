...
import '{import&#x3D;model.TransactionNotificationRequestV4, classname&#x3D;TransactionNotificationRequestV4}';
...
class GeneralApi {
  ...
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformTransactionCreated({ 
    ...
    final _path = r'/balancePlatform.transaction.created';
    ...
    try {
      const _type = FullType(TransactionNotificationRequestV4);
      _bodyData = transactionNotificationRequestV4 == null ? null : _serializers.serialize(transactionNotificationRequestV4, specifiedType: _type);
