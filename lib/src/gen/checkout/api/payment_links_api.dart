...
class PaymentLinksApi {
  ...
  const PaymentLinksApi(this._dio, this._serializers);

  /// Get a payment link
  /// Retrieves the payment link details using the payment link &#x60;id&#x60;.
  ///
  /// Parameters:
  /// * [linkId] - Unique identifier of the payment link.
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PaymentLinkResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentLinkResponse>> getPaymentLinksLinkId({ 
    ...
    final _path = r'/paymentLinks/{linkId}'.replaceAll('{' r'linkId' '}', encodeQueryParameter(_serializers, linkId, const FullType(String)).toString());
    ...
    PaymentLinkResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaymentLinkResponse),
  ...
  /// Returns a [Future] containing a [Response] with a [PaymentLinkResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentLinkResponse>> patchPaymentLinksLinkId({ 
    required String linkId,
    ...
    try {
      const _type = FullType(UpdatePaymentLinkRequest);
      _bodyData = updatePaymentLinkRequest == null ? null : _serializers.serialize(updatePaymentLinkRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [PaymentLinkResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentLinkResponse>> postPaymentLinks({ 
    ...
    try {
      const _type = FullType(PaymentLinkRequest);
      _bodyData = paymentLinkRequest == null ? null : _serializers.serialize(paymentLinkRequest, specifiedType: _type);
