...
class _$FraudResult extends FraudResult {
  ...
  @override
  final BuiltList<FraudCheckResult>? results;
...
class FraudResultBuilder implements Builder<FraudResult, FraudResultBuilder> {
  ...
  ListBuilder<FraudCheckResult>? _results;
  ListBuilder<FraudCheckResult> get results =>
      _$this._results ??= ListBuilder<FraudCheckResult>();
  set results(ListBuilder<FraudCheckResult>? results) =>
