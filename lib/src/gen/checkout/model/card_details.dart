...
abstract class CardDetails implements Built<CardDetails, CardDetailsBuilder> {
  ...
  CardDetailsFundingSourceEnum? get fundingSource;
  ...
  static void _defaults(CardDetailsBuilder b) => b
      ..type = CardDetailsTypeEnum.valueOf('scheme');
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.fundingSource != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(CardDetailsFundingSourceEnum),
      );
    }
    ...
    if (object.type != null) {
      ...
      yield serializers.serialize(
        object.type,
        specifiedType: const FullType(CardDetailsTypeEnum),
      );
    }
  }
      ...
      switch (key) {
        ...
        case r'fundingSource':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(CardDetailsFundingSourceEnum),
          ) as CardDetailsFundingSourceEnum;
...
class CardDetailsFundingSourceEnum extends EnumClass {

  /// The funding source that should be used when multiple sources are available. For Brazilian combo cards, by default the funding source is credit. To use debit, set this value to **debit**.
  @BuiltValueEnumConst(wireName: r'credit')
  static const CardDetailsFundingSourceEnum credit = _$cardDetailsFundingSourceEnum_credit;
  /// The funding source that should be used when multiple sources are available. For Brazilian combo cards, by default the funding source is credit. To use debit, set this value to **debit**.
  @BuiltValueEnumConst(wireName: r'debit')
  static const CardDetailsFundingSourceEnum debit = _$cardDetailsFundingSourceEnum_debit;
  /// The funding source that should be used when multiple sources are available. For Brazilian combo cards, by default the funding source is credit. To use debit, set this value to **debit**.
  @BuiltValueEnumConst(wireName: r'prepaid')
  static const CardDetailsFundingSourceEnum prepaid = _$cardDetailsFundingSourceEnum_prepaid;
  /// The funding source that should be used when multiple sources are available. For Brazilian combo cards, by default the funding source is credit. To use debit, set this value to **debit**.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const CardDetailsFundingSourceEnum unknownDefaultOpenApi = _$cardDetailsFundingSourceEnum_unknownDefaultOpenApi;

  static Serializer<CardDetailsFundingSourceEnum> get serializer => _$cardDetailsFundingSourceEnumSerializer;

  const CardDetailsFundingSourceEnum._(String name): super(name);

  static BuiltSet<CardDetailsFundingSourceEnum> get values => _$cardDetailsFundingSourceEnumValues;
  static CardDetailsFundingSourceEnum valueOf(String name) => _$cardDetailsFundingSourceEnumValueOf(name);
}

class CardDetailsTypeEnum extends EnumClass {

  /// Default payment method details. Common for scheme payment methods, and for simple payment method details.
  @BuiltValueEnumConst(wireName: r'bcmc')
  static const CardDetailsTypeEnum bcmc = _$cardDetailsTypeEnum_bcmc;
  /// Default payment method details. Common for scheme payment methods, and for simple payment method details.
  @BuiltValueEnumConst(wireName: r'scheme')
  static const CardDetailsTypeEnum scheme = _$cardDetailsTypeEnum_scheme;
  /// Default payment method details. Common for scheme payment methods, and for simple payment method details.
  @BuiltValueEnumConst(wireName: r'networkToken')
  static const CardDetailsTypeEnum networkToken = _$cardDetailsTypeEnum_networkToken;
  /// Default payment method details. Common for scheme payment methods, and for simple payment method details.
  @BuiltValueEnumConst(wireName: r'giftcard')
  static const CardDetailsTypeEnum giftcard = _$cardDetailsTypeEnum_giftcard;
  /// Default payment method details. Common for scheme payment methods, and for simple payment method details.
  @BuiltValueEnumConst(wireName: r'card')
  static const CardDetailsTypeEnum card = _$cardDetailsTypeEnum_card;
  /// Default payment method details. Common for scheme payment methods, and for simple payment method details.
  @BuiltValueEnumConst(wireName: r'clicktopay')
  static const CardDetailsTypeEnum clicktopay = _$cardDetailsTypeEnum_clicktopay;
  /// Default payment method details. Common for scheme payment methods, and for simple payment method details.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const CardDetailsTypeEnum unknownDefaultOpenApi = _$cardDetailsTypeEnum_unknownDefaultOpenApi;

  static Serializer<CardDetailsTypeEnum> get serializer => _$cardDetailsTypeEnumSerializer;

  const CardDetailsTypeEnum._(String name): super(name);

  static BuiltSet<CardDetailsTypeEnum> get values => _$cardDetailsTypeEnumValues;
  static CardDetailsTypeEnum valueOf(String name) => _$cardDetailsTypeEnumValueOf(name);
}
