...
@BuiltValue()
abstract class PaymentLinkRequest implements Built<PaymentLinkRequest, PaymentLinkRequestBuilder> {
  ...
  PaymentLinkRequestRecurringProcessingModelEnum? get recurringProcessingModel;
  ...
  PaymentLinkRequestStorePaymentMethodModeEnum? get storePaymentMethodMode;
  ...
  PaymentLinkRequest._();

  factory PaymentLinkRequest([void updates(PaymentLinkRequestBuilder b)]) = _$PaymentLinkRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentLinkRequestBuilder b) => b
      ..showRemovePaymentMethodButton = true
      ..splitCardFundingSources = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentLinkRequest> get serializer => _$PaymentLinkRequestSerializer();
}

class _$PaymentLinkRequestSerializer implements PrimitiveSerializer<PaymentLinkRequest> {
  @override
  final Iterable<Type> types = const [PaymentLinkRequest, _$PaymentLinkRequest];

  @override
  final String wireName = r'PaymentLinkRequest';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.recurringProcessingModel != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(PaymentLinkRequestRecurringProcessingModelEnum),
      );
    }
    yield r'reference';
    yield serializers.serialize(
    ...
    if (object.requiredShopperFields != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(PaymentLinkRequestRequiredShopperFieldsEnum)]),
      );
    }
    ...
    if (object.storePaymentMethodMode != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(PaymentLinkRequestStorePaymentMethodModeEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PaymentLinkRequestBuilder result,
      ...
      switch (key) {
        ...
        case r'recurringProcessingModel':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PaymentLinkRequestRecurringProcessingModelEnum),
          ) as PaymentLinkRequestRecurringProcessingModelEnum;
        ...
        case r'requiredShopperFields':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(PaymentLinkRequestRequiredShopperFieldsEnum)]),
          ) as BuiltList<PaymentLinkRequestRequiredShopperFieldsEnum>;
        ...
        case r'storePaymentMethodMode':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PaymentLinkRequestStorePaymentMethodModeEnum),
          ) as PaymentLinkRequestStorePaymentMethodModeEnum;
  ...
  @override
  PaymentLinkRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentLinkRequestBuilder();
...
class PaymentLinkRequestRecurringProcessingModelEnum extends EnumClass {

  /// Defines a recurring payment type. Required when `storePaymentMethodMode` is set to **askForConsent** or **enabled**. Possible values: * **Subscription** – A transaction for a fixed or variable amount, which follows a fixed schedule. * **CardOnFile** – With a card-on-file (CoF) transaction, card details are stored to enable one-click or omnichannel journeys, or simply to streamline the checkout process. Any subscription not following a fixed schedule is also considered a card-on-file transaction. * **UnscheduledCardOnFile** – An unscheduled card-on-file (UCoF) transaction is a transaction that occurs on a non-fixed schedule and/or has variable amounts. For example, automatic top-ups when a cardholder's balance drops below a certain amount. 
  @BuiltValueEnumConst(wireName: r'CardOnFile')
  static const PaymentLinkRequestRecurringProcessingModelEnum cardOnFile = _$paymentLinkRequestRecurringProcessingModelEnum_cardOnFile;
  /// Defines a recurring payment type. Required when `storePaymentMethodMode` is set to **askForConsent** or **enabled**. Possible values: * **Subscription** – A transaction for a fixed or variable amount, which follows a fixed schedule. * **CardOnFile** – With a card-on-file (CoF) transaction, card details are stored to enable one-click or omnichannel journeys, or simply to streamline the checkout process. Any subscription not following a fixed schedule is also considered a card-on-file transaction. * **UnscheduledCardOnFile** – An unscheduled card-on-file (UCoF) transaction is a transaction that occurs on a non-fixed schedule and/or has variable amounts. For example, automatic top-ups when a cardholder's balance drops below a certain amount. 
  @BuiltValueEnumConst(wireName: r'Subscription')
  static const PaymentLinkRequestRecurringProcessingModelEnum subscription = _$paymentLinkRequestRecurringProcessingModelEnum_subscription;
  /// Defines a recurring payment type. Required when `storePaymentMethodMode` is set to **askForConsent** or **enabled**. Possible values: * **Subscription** – A transaction for a fixed or variable amount, which follows a fixed schedule. * **CardOnFile** – With a card-on-file (CoF) transaction, card details are stored to enable one-click or omnichannel journeys, or simply to streamline the checkout process. Any subscription not following a fixed schedule is also considered a card-on-file transaction. * **UnscheduledCardOnFile** – An unscheduled card-on-file (UCoF) transaction is a transaction that occurs on a non-fixed schedule and/or has variable amounts. For example, automatic top-ups when a cardholder's balance drops below a certain amount. 
  @BuiltValueEnumConst(wireName: r'UnscheduledCardOnFile')
  static const PaymentLinkRequestRecurringProcessingModelEnum unscheduledCardOnFile = _$paymentLinkRequestRecurringProcessingModelEnum_unscheduledCardOnFile;
  /// Defines a recurring payment type. Required when `storePaymentMethodMode` is set to **askForConsent** or **enabled**. Possible values: * **Subscription** – A transaction for a fixed or variable amount, which follows a fixed schedule. * **CardOnFile** – With a card-on-file (CoF) transaction, card details are stored to enable one-click or omnichannel journeys, or simply to streamline the checkout process. Any subscription not following a fixed schedule is also considered a card-on-file transaction. * **UnscheduledCardOnFile** – An unscheduled card-on-file (UCoF) transaction is a transaction that occurs on a non-fixed schedule and/or has variable amounts. For example, automatic top-ups when a cardholder's balance drops below a certain amount. 
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const PaymentLinkRequestRecurringProcessingModelEnum unknownDefaultOpenApi = _$paymentLinkRequestRecurringProcessingModelEnum_unknownDefaultOpenApi;

  static Serializer<PaymentLinkRequestRecurringProcessingModelEnum> get serializer => _$paymentLinkRequestRecurringProcessingModelEnumSerializer;

  const PaymentLinkRequestRecurringProcessingModelEnum._(String name): super(name);

  static BuiltSet<PaymentLinkRequestRecurringProcessingModelEnum> get values => _$paymentLinkRequestRecurringProcessingModelEnumValues;
  static PaymentLinkRequestRecurringProcessingModelEnum valueOf(String name) => _$paymentLinkRequestRecurringProcessingModelEnumValueOf(name);
}

class PaymentLinkRequestRequiredShopperFieldsEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'billingAddress')
  static const PaymentLinkRequestRequiredShopperFieldsEnum billingAddress = _$paymentLinkRequestRequiredShopperFieldsEnum_billingAddress;
  @BuiltValueEnumConst(wireName: r'deliveryAddress')
  static const PaymentLinkRequestRequiredShopperFieldsEnum deliveryAddress = _$paymentLinkRequestRequiredShopperFieldsEnum_deliveryAddress;
  @BuiltValueEnumConst(wireName: r'shopperEmail')
  static const PaymentLinkRequestRequiredShopperFieldsEnum shopperEmail = _$paymentLinkRequestRequiredShopperFieldsEnum_shopperEmail;
  @BuiltValueEnumConst(wireName: r'shopperName')
  static const PaymentLinkRequestRequiredShopperFieldsEnum shopperName = _$paymentLinkRequestRequiredShopperFieldsEnum_shopperName;
  @BuiltValueEnumConst(wireName: r'telephoneNumber')
  static const PaymentLinkRequestRequiredShopperFieldsEnum telephoneNumber = _$paymentLinkRequestRequiredShopperFieldsEnum_telephoneNumber;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const PaymentLinkRequestRequiredShopperFieldsEnum unknownDefaultOpenApi = _$paymentLinkRequestRequiredShopperFieldsEnum_unknownDefaultOpenApi;

  static Serializer<PaymentLinkRequestRequiredShopperFieldsEnum> get serializer => _$paymentLinkRequestRequiredShopperFieldsEnumSerializer;

  const PaymentLinkRequestRequiredShopperFieldsEnum._(String name): super(name);

  static BuiltSet<PaymentLinkRequestRequiredShopperFieldsEnum> get values => _$paymentLinkRequestRequiredShopperFieldsEnumValues;
  static PaymentLinkRequestRequiredShopperFieldsEnum valueOf(String name) => _$paymentLinkRequestRequiredShopperFieldsEnumValueOf(name);
}

class PaymentLinkRequestStorePaymentMethodModeEnum extends EnumClass {

  /// Indicates if the details of the payment method will be stored for the shopper. Possible values: * **disabled** – No details will be stored (default). * **askForConsent** – If the `shopperReference` is provided, the UI lets the shopper choose if they want their payment details to be stored. * **enabled** – If the `shopperReference` is provided, the details will be stored without asking the shopper for consent.   When set to **askForConsent** or **enabled**, you must also include the `recurringProcessingModel` parameter.
  @BuiltValueEnumConst(wireName: r'askForConsent')
  static const PaymentLinkRequestStorePaymentMethodModeEnum askForConsent = _$paymentLinkRequestStorePaymentMethodModeEnum_askForConsent;
  /// Indicates if the details of the payment method will be stored for the shopper. Possible values: * **disabled** – No details will be stored (default). * **askForConsent** – If the `shopperReference` is provided, the UI lets the shopper choose if they want their payment details to be stored. * **enabled** – If the `shopperReference` is provided, the details will be stored without asking the shopper for consent.   When set to **askForConsent** or **enabled**, you must also include the `recurringProcessingModel` parameter.
  @BuiltValueEnumConst(wireName: r'disabled')
  static const PaymentLinkRequestStorePaymentMethodModeEnum disabled = _$paymentLinkRequestStorePaymentMethodModeEnum_disabled;
  /// Indicates if the details of the payment method will be stored for the shopper. Possible values: * **disabled** – No details will be stored (default). * **askForConsent** – If the `shopperReference` is provided, the UI lets the shopper choose if they want their payment details to be stored. * **enabled** – If the `shopperReference` is provided, the details will be stored without asking the shopper for consent.   When set to **askForConsent** or **enabled**, you must also include the `recurringProcessingModel` parameter.
  @BuiltValueEnumConst(wireName: r'enabled')
  static const PaymentLinkRequestStorePaymentMethodModeEnum enabled = _$paymentLinkRequestStorePaymentMethodModeEnum_enabled;
  /// Indicates if the details of the payment method will be stored for the shopper. Possible values: * **disabled** – No details will be stored (default). * **askForConsent** – If the `shopperReference` is provided, the UI lets the shopper choose if they want their payment details to be stored. * **enabled** – If the `shopperReference` is provided, the details will be stored without asking the shopper for consent.   When set to **askForConsent** or **enabled**, you must also include the `recurringProcessingModel` parameter.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const PaymentLinkRequestStorePaymentMethodModeEnum unknownDefaultOpenApi = _$paymentLinkRequestStorePaymentMethodModeEnum_unknownDefaultOpenApi;

  static Serializer<PaymentLinkRequestStorePaymentMethodModeEnum> get serializer => _$paymentLinkRequestStorePaymentMethodModeEnumSerializer;

  const PaymentLinkRequestStorePaymentMethodModeEnum._(String name): super(name);

  static BuiltSet<PaymentLinkRequestStorePaymentMethodModeEnum> get values => _$paymentLinkRequestStorePaymentMethodModeEnumValues;
  static PaymentLinkRequestStorePaymentMethodModeEnum valueOf(String name) => _$paymentLinkRequestStorePaymentMethodModeEnumValueOf(name);
}
