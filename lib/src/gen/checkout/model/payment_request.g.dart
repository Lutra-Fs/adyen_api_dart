...
const PaymentRequestChannelEnum _$paymentRequestChannelEnum_iOS =
    const PaymentRequestChannelEnum._('iOS');
const PaymentRequestChannelEnum _$paymentRequestChannelEnum_android =
    const PaymentRequestChannelEnum._('android');
const PaymentRequestChannelEnum _$paymentRequestChannelEnum_web =
    const PaymentRequestChannelEnum._('web');
const PaymentRequestChannelEnum
_$paymentRequestChannelEnum_unknownDefaultOpenApi =
    const PaymentRequestChannelEnum._('unknownDefaultOpenApi');

PaymentRequestChannelEnum _$paymentRequestChannelEnumValueOf(String name) {
  switch (name) {
    case 'iOS':
      return _$paymentRequestChannelEnum_iOS;
    case 'android':
      return _$paymentRequestChannelEnum_android;
    case 'web':
      return _$paymentRequestChannelEnum_web;
    case 'unknownDefaultOpenApi':
      return _$paymentRequestChannelEnum_unknownDefaultOpenApi;
    default:
      return _$paymentRequestChannelEnum_unknownDefaultOpenApi;
  }
}

final BuiltSet<PaymentRequestChannelEnum> _$paymentRequestChannelEnumValues =
    BuiltSet<PaymentRequestChannelEnum>(const <PaymentRequestChannelEnum>[
      _$paymentRequestChannelEnum_iOS,
      _$paymentRequestChannelEnum_android,
      _$paymentRequestChannelEnum_web,
      _$paymentRequestChannelEnum_unknownDefaultOpenApi,
    ]);
...
const PaymentRequestIndustryUsageEnum
_$paymentRequestIndustryUsageEnum_delayedCharge =
    const PaymentRequestIndustryUsageEnum._('delayedCharge');
const PaymentRequestIndustryUsageEnum
_$paymentRequestIndustryUsageEnum_installment =
    const PaymentRequestIndustryUsageEnum._('installment');
const PaymentRequestIndustryUsageEnum _$paymentRequestIndustryUsageEnum_noShow =
    const PaymentRequestIndustryUsageEnum._('noShow');
const PaymentRequestIndustryUsageEnum
_$paymentRequestIndustryUsageEnum_unknownDefaultOpenApi =
    const PaymentRequestIndustryUsageEnum._('unknownDefaultOpenApi');

PaymentRequestIndustryUsageEnum _$paymentRequestIndustryUsageEnumValueOf(
  String name,
) {
  switch (name) {
    case 'delayedCharge':
      return _$paymentRequestIndustryUsageEnum_delayedCharge;
    case 'installment':
      return _$paymentRequestIndustryUsageEnum_installment;
    case 'noShow':
      return _$paymentRequestIndustryUsageEnum_noShow;
    case 'unknownDefaultOpenApi':
      return _$paymentRequestIndustryUsageEnum_unknownDefaultOpenApi;
    default:
      return _$paymentRequestIndustryUsageEnum_unknownDefaultOpenApi;
  }
}

final BuiltSet<PaymentRequestIndustryUsageEnum>
_$paymentRequestIndustryUsageEnumValues =
    BuiltSet<PaymentRequestIndustryUsageEnum>(
      const <PaymentRequestIndustryUsageEnum>[
        _$paymentRequestIndustryUsageEnum_delayedCharge,
        _$paymentRequestIndustryUsageEnum_installment,
        _$paymentRequestIndustryUsageEnum_noShow,
        _$paymentRequestIndustryUsageEnum_unknownDefaultOpenApi,
      ],
    );
...
Serializer<PaymentRequestChannelEnum> _$paymentRequestChannelEnumSerializer =
    _$PaymentRequestChannelEnumSerializer();
Serializer<PaymentRequestEntityTypeEnum>
_$paymentRequestEntityTypeEnumSerializer =
    _$PaymentRequestEntityTypeEnumSerializer();
Serializer<PaymentRequestIndustryUsageEnum>
_$paymentRequestIndustryUsageEnumSerializer =
    _$PaymentRequestIndustryUsageEnumSerializer();
...
class _$PaymentRequestChannelEnumSerializer
    implements PrimitiveSerializer<PaymentRequestChannelEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[PaymentRequestChannelEnum];
  @override
  final String wireName = 'PaymentRequestChannelEnum';

  @override
  Object serialize(
    Serializers serializers,
    PaymentRequestChannelEnum object, {
    FullType specifiedType = FullType.unspecified,
  }) => _toWire[object.name] ?? object.name;

  @override
  PaymentRequestChannelEnum deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) => PaymentRequestChannelEnum.valueOf(
...
class _$PaymentRequestIndustryUsageEnumSerializer
    implements PrimitiveSerializer<PaymentRequestIndustryUsageEnum> {
  static const Map<String, Object> _toWire = const <String, Object>{
  ...
  @override
  final Iterable<Type> types = const <Type>[PaymentRequestIndustryUsageEnum];
  @override
  final String wireName = 'PaymentRequestIndustryUsageEnum';

  @override
  Object serialize(
    Serializers serializers,
    PaymentRequestIndustryUsageEnum object, {
    FullType specifiedType = FullType.unspecified,
  }) => _toWire[object.name] ?? object.name;

  @override
  PaymentRequestIndustryUsageEnum deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) => PaymentRequestIndustryUsageEnum.valueOf(
    _fromWire[serialized] ?? (serialized is String ? serialized : ''),
  );
}
...
class _$PaymentRequest extends PaymentRequest {
  ...
  @override
  final CheckoutBankAccount? bankAccount;
  @override
  ...
  @override
  final PaymentRequestChannelEnum? channel;
  @override
  ...
  @override
  final bool? enableOneClick;
  @override
  final bool? enablePayOut;
  @override
  ...
  @override
  final FundOrigin? fundOrigin;
  @override
  final FundRecipient? fundRecipient;
  @override
  final PaymentRequestIndustryUsageEnum? industryUsage;
  @override
  ...
  final String? origin;
  @override
  final PaymentRequestPaymentMethod paymentMethod;
  @override
  final PaymentValidations? paymentValidations;
  @override
  final PlatformChargebackLogic? platformChargebackLogic;
  @override
  final String? recurringExpiry;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is PaymentRequest &&
        ...
        enableOneClick == other.enableOneClick &&
        enablePayOut == other.enablePayOut &&
        enableRecurring == other.enableRecurring &&
        enhancedSchemeData == other.enhancedSchemeData &&
        entityType == other.entityType &&
        fraudOffset == other.fraudOffset &&
        fundOrigin == other.fundOrigin &&
        fundRecipient == other.fundRecipient &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, enableOneClick.hashCode);
    _$hash = $jc(_$hash, enablePayOut.hashCode);
    _$hash = $jc(_$hash, enableRecurring.hashCode);
    _$hash = $jc(_$hash, enhancedSchemeData.hashCode);
    _$hash = $jc(_$hash, entityType.hashCode);
    _$hash = $jc(_$hash, fraudOffset.hashCode);
    _$hash = $jc(_$hash, fundOrigin.hashCode);
    _$hash = $jc(_$hash, fundRecipient.hashCode);
    ...
    _$hash = $jc(_$hash, riskData.hashCode);
    ...
    _$hash = $jc(_$hash, storePaymentMethod.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'PaymentRequest')
          ...
          ..add('enableOneClick', enableOneClick)
          ..add('enablePayOut', enablePayOut)
          ..add('enableRecurring', enableRecurring)
          ..add('enhancedSchemeData', enhancedSchemeData)
          ..add('entityType', entityType)
          ..add('fraudOffset', fraudOffset)
          ..add('fundOrigin', fundOrigin)
          ..add('fundRecipient', fundRecipient)
...
class PaymentRequestBuilder
  ...
  CheckoutBankAccountBuilder? _bankAccount;
  CheckoutBankAccountBuilder get bankAccount =>
      _$this._bankAccount ??= CheckoutBankAccountBuilder();
  set bankAccount(CheckoutBankAccountBuilder? bankAccount) =>
  ...
  PaymentRequestChannelEnum? _channel;
  PaymentRequestChannelEnum? get channel => _$this._channel;
  set channel(PaymentRequestChannelEnum? channel) => _$this._channel = channel;
  ...
  bool? _enableOneClick;
  bool? get enableOneClick => _$this._enableOneClick;
  set enableOneClick(bool? enableOneClick) =>
      _$this._enableOneClick = enableOneClick;

  bool? _enablePayOut;
  bool? get enablePayOut => _$this._enablePayOut;
  set enablePayOut(bool? enablePayOut) => _$this._enablePayOut = enablePayOut;

  bool? _enableRecurring;
  bool? get enableRecurring => _$this._enableRecurring;
  set enableRecurring(bool? enableRecurring) =>
      _$this._enableRecurring = enableRecurring;
  ...
  FundOriginBuilder? _fundOrigin;
  FundOriginBuilder get fundOrigin =>
      _$this._fundOrigin ??= FundOriginBuilder();
  set fundOrigin(FundOriginBuilder? fundOrigin) =>
      _$this._fundOrigin = fundOrigin;

  FundRecipientBuilder? _fundRecipient;
  ...
  PaymentRequestIndustryUsageEnum? _industryUsage;
  PaymentRequestIndustryUsageEnum? get industryUsage => _$this._industryUsage;
  set industryUsage(PaymentRequestIndustryUsageEnum? industryUsage) =>
  ...
  PaymentRequestPaymentMethodBuilder? _paymentMethod;
  PaymentRequestPaymentMethodBuilder get paymentMethod =>
      _$this._paymentMethod ??= PaymentRequestPaymentMethodBuilder();
  set paymentMethod(PaymentRequestPaymentMethodBuilder? paymentMethod) =>
      _$this._paymentMethod = paymentMethod;

  PaymentValidationsBuilder? _paymentValidations;
  PaymentValidationsBuilder get paymentValidations =>
      _$this._paymentValidations ??= PaymentValidationsBuilder();
  set paymentValidations(PaymentValidationsBuilder? paymentValidations) =>
  ...
  String? _recurringExpiry;
  String? get recurringExpiry => _$this._recurringExpiry;
  set recurringExpiry(String? recurringExpiry) =>
  ...
  RiskDataBuilder? _riskData;
  RiskDataBuilder get riskData => _$this._riskData ??= RiskDataBuilder();
  set riskData(RiskDataBuilder? riskData) => _$this._riskData = riskData;
  ...
  PaymentRequestBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _enableOneClick = $v.enableOneClick;
      _enablePayOut = $v.enablePayOut;
      _enableRecurring = $v.enableRecurring;
      _enhancedSchemeData = $v.enhancedSchemeData?.toBuilder();
      _entityType = $v.entityType;
      _fraudOffset = $v.fraudOffset;
      _fundOrigin = $v.fundOrigin?.toBuilder();
      _fundRecipient = $v.fundRecipient?.toBuilder();
      ...
      _riskData = $v.riskData?.toBuilder();
    ...
    try {
      _$result =
          ...
          _$PaymentRequest._(
            ...
            fundOrigin: _fundOrigin?.build(),
            fundRecipient: _fundRecipient?.build(),
      ...
      try {
        ...
        _$failedField = 'fundOrigin';
        _fundOrigin?.build();
        _$failedField = 'fundRecipient';
        _fundRecipient?.build();
