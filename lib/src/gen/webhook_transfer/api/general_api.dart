...
class GeneralApi {
  ...
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformTransferCreated({ 
    ...
    final _path = r'/balancePlatform.transfer.created';
    ...
    try {
      const _type = FullType(TransferNotificationRequest);
      _bodyData = transferNotificationRequest == null ? null : _serializers.serialize(transferNotificationRequest, specifiedType: _type);
  ...
  /// Transfer updated
  /// Adyen sends this webhook when the status of a transfer changes. Use the &#x60;data.id&#x60; to track the original transfer resource in the [balancePlatform.transfer.created](https://docs.adyen.com/api-explorer/transfer-webhooks/1/post/balancePlatform.transfer.created) webhook.  The &#x60;status&#x60; field indicates the event that triggered the webhook.   
  ///
  /// Parameters:
  /// * [transferNotificationRequest] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future] containing a [Response] with a [BalancePlatformNotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformTransferUpdated({ 
    TransferNotificationRequest? transferNotificationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/balancePlatform.transfer.updated';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
