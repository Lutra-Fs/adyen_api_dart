...
part 'void_pending_refund_request.g.dart';
...
@BuiltValue()
abstract class VoidPendingRefundRequest implements Built<VoidPendingRefundRequest, VoidPendingRefundRequestBuilder> {
  ...
  VoidPendingRefundRequest._();

  factory VoidPendingRefundRequest([void updates(VoidPendingRefundRequestBuilder b)]) = _$VoidPendingRefundRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VoidPendingRefundRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<VoidPendingRefundRequest> get serializer => _$VoidPendingRefundRequestSerializer();
}

class _$VoidPendingRefundRequestSerializer implements PrimitiveSerializer<VoidPendingRefundRequest> {
  @override
  final Iterable<Type> types = const [VoidPendingRefundRequest, _$VoidPendingRefundRequest];

  @override
  final String wireName = r'VoidPendingRefundRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    VoidPendingRefundRequest object, {
    ...
    if (object.modificationAmount != null) {
  ...
  void _deserializeProperties(
    ...
    required VoidPendingRefundRequestBuilder result,
  ...
  @override
  VoidPendingRefundRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = VoidPendingRefundRequestBuilder();
