...
part of 'adjust_authorisation_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AdjustAuthorisationRequest extends AdjustAuthorisationRequest {
  @override
  ...
  factory _$AdjustAuthorisationRequest([
    void Function(AdjustAuthorisationRequestBuilder)? updates,
  ]) => (AdjustAuthorisationRequestBuilder()..update(updates))._build();

  _$AdjustAuthorisationRequest._({
    this.additionalData,
  ...
  @override
  AdjustAuthorisationRequest rebuild(
    void Function(AdjustAuthorisationRequestBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  AdjustAuthorisationRequestBuilder toBuilder() =>
      AdjustAuthorisationRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AdjustAuthorisationRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AdjustAuthorisationRequest')
...
class AdjustAuthorisationRequestBuilder
    implements
        Builder<AdjustAuthorisationRequest, AdjustAuthorisationRequestBuilder> {
  _$AdjustAuthorisationRequest? _$v;
  ...
  AdjustAuthorisationRequestBuilder() {
    AdjustAuthorisationRequest._defaults(this);
  }

  AdjustAuthorisationRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AdjustAuthorisationRequest other) {
    _$v = other as _$AdjustAuthorisationRequest;
  }

  @override
  void update(void Function(AdjustAuthorisationRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AdjustAuthorisationRequest build() => _build();

  _$AdjustAuthorisationRequest _build() {
    _$AdjustAuthorisationRequest _$result;
    try {
      _$result =
          _$v ??
          _$AdjustAuthorisationRequest._(
