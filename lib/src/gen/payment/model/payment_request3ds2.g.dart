...
part of 'payment_request3ds2.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const PaymentRequest3ds2RecurringProcessingModelEnum
_$paymentRequest3ds2RecurringProcessingModelEnum_cardOnFile =
    const PaymentRequest3ds2RecurringProcessingModelEnum._('cardOnFile');
const PaymentRequest3ds2RecurringProcessingModelEnum
_$paymentRequest3ds2RecurringProcessingModelEnum_subscription =
    const PaymentRequest3ds2RecurringProcessingModelEnum._('subscription');
const PaymentRequest3ds2RecurringProcessingModelEnum
_$paymentRequest3ds2RecurringProcessingModelEnum_unscheduledCardOnFile =
    const PaymentRequest3ds2RecurringProcessingModelEnum._(
      'unscheduledCardOnFile',
    );
const PaymentRequest3ds2RecurringProcessingModelEnum
_$paymentRequest3ds2RecurringProcessingModelEnum_unknownDefaultOpenApi =
    const PaymentRequest3ds2RecurringProcessingModelEnum._(
      'unknownDefaultOpenApi',
    );

PaymentRequest3ds2RecurringProcessingModelEnum
_$paymentRequest3ds2RecurringProcessingModelEnumValueOf(String name) {
  switch (name) {
    case 'cardOnFile':
      return _$paymentRequest3ds2RecurringProcessingModelEnum_cardOnFile;
    case 'subscription':
      return _$paymentRequest3ds2RecurringProcessingModelEnum_subscription;
    case 'unscheduledCardOnFile':
      return _$paymentRequest3ds2RecurringProcessingModelEnum_unscheduledCardOnFile;
    case 'unknownDefaultOpenApi':
      return _$paymentRequest3ds2RecurringProcessingModelEnum_unknownDefaultOpenApi;
    default:
      return _$paymentRequest3ds2RecurringProcessingModelEnum_unknownDefaultOpenApi;
  }
}

final BuiltSet<PaymentRequest3ds2RecurringProcessingModelEnum>
_$paymentRequest3ds2RecurringProcessingModelEnumValues =
    BuiltSet<PaymentRequest3ds2RecurringProcessingModelEnum>(
      const <PaymentRequest3ds2RecurringProcessingModelEnum>[
        _$paymentRequest3ds2RecurringProcessingModelEnum_cardOnFile,
        _$paymentRequest3ds2RecurringProcessingModelEnum_subscription,
        _$paymentRequest3ds2RecurringProcessingModelEnum_unscheduledCardOnFile,
...
const PaymentRequest3ds2ShopperInteractionEnum
_$paymentRequest3ds2ShopperInteractionEnum_ecommerce =
    const PaymentRequest3ds2ShopperInteractionEnum._('ecommerce');
const PaymentRequest3ds2ShopperInteractionEnum
_$paymentRequest3ds2ShopperInteractionEnum_contAuth =
    const PaymentRequest3ds2ShopperInteractionEnum._('contAuth');
const PaymentRequest3ds2ShopperInteractionEnum
_$paymentRequest3ds2ShopperInteractionEnum_moto =
    const PaymentRequest3ds2ShopperInteractionEnum._('moto');
const PaymentRequest3ds2ShopperInteractionEnum
_$paymentRequest3ds2ShopperInteractionEnum_POS =
    const PaymentRequest3ds2ShopperInteractionEnum._('POS');
const PaymentRequest3ds2ShopperInteractionEnum
_$paymentRequest3ds2ShopperInteractionEnum_unknownDefaultOpenApi =
    const PaymentRequest3ds2ShopperInteractionEnum._('unknownDefaultOpenApi');

PaymentRequest3ds2ShopperInteractionEnum
_$paymentRequest3ds2ShopperInteractionEnumValueOf(String name) {
  switch (name) {
    case 'ecommerce':
      return _$paymentRequest3ds2ShopperInteractionEnum_ecommerce;
    case 'contAuth':
      return _$paymentRequest3ds2ShopperInteractionEnum_contAuth;
    case 'moto':
      return _$paymentRequest3ds2ShopperInteractionEnum_moto;
    case 'POS':
      return _$paymentRequest3ds2ShopperInteractionEnum_POS;
    case 'unknownDefaultOpenApi':
      return _$paymentRequest3ds2ShopperInteractionEnum_unknownDefaultOpenApi;
    default:
      return _$paymentRequest3ds2ShopperInteractionEnum_unknownDefaultOpenApi;
  }
}

final BuiltSet<PaymentRequest3ds2ShopperInteractionEnum>
_$paymentRequest3ds2ShopperInteractionEnumValues =
    BuiltSet<PaymentRequest3ds2ShopperInteractionEnum>(
      const <PaymentRequest3ds2ShopperInteractionEnum>[
        _$paymentRequest3ds2ShopperInteractionEnum_ecommerce,
        _$paymentRequest3ds2ShopperInteractionEnum_contAuth,
        _$paymentRequest3ds2ShopperInteractionEnum_moto,
...
Serializer<PaymentRequest3ds2RecurringProcessingModelEnum>
_$paymentRequest3ds2RecurringProcessingModelEnumSerializer =
    _$PaymentRequest3ds2RecurringProcessingModelEnumSerializer();
Serializer<PaymentRequest3ds2ShopperInteractionEnum>
_$paymentRequest3ds2ShopperInteractionEnumSerializer =
    _$PaymentRequest3ds2ShopperInteractionEnumSerializer();

class _$PaymentRequest3ds2RecurringProcessingModelEnumSerializer
    implements
        PrimitiveSerializer<PaymentRequest3ds2RecurringProcessingModelEnum> {
  ...
  @override
  final String wireName = 'PaymentRequest3ds2RecurringProcessingModelEnum';

  @override
  Object serialize(
    Serializers serializers,
    PaymentRequest3ds2RecurringProcessingModelEnum object, {
    FullType specifiedType = FullType.unspecified,
  }) => _toWire[object.name] ?? object.name;

  @override
  PaymentRequest3ds2RecurringProcessingModelEnum deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) => PaymentRequest3ds2RecurringProcessingModelEnum.valueOf(
    _fromWire[serialized] ?? (serialized is String ? serialized : ''),
  );
}

class _$PaymentRequest3ds2ShopperInteractionEnumSerializer
    implements PrimitiveSerializer<PaymentRequest3ds2ShopperInteractionEnum> {
  static const Map<String, Object> _toWire = const <String, Object>{
    'ecommerce': 'Ecommerce',
    'contAuth': 'ContAuth',
    'moto': 'Moto',
  ...
  @override
  final String wireName = 'PaymentRequest3ds2ShopperInteractionEnum';

  @override
  Object serialize(
    Serializers serializers,
    PaymentRequest3ds2ShopperInteractionEnum object, {
    FullType specifiedType = FullType.unspecified,
  }) => _toWire[object.name] ?? object.name;

  @override
  PaymentRequest3ds2ShopperInteractionEnum deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) => PaymentRequest3ds2ShopperInteractionEnum.valueOf(
    _fromWire[serialized] ?? (serialized is String ? serialized : ''),
  );
}

class _$PaymentRequest3ds2 extends PaymentRequest3ds2 {
  @override
  ...
  @override
  final PaymentRequest3ds2RecurringProcessingModelEnum?
  ...
  @override
  final PaymentRequest3ds2ShopperInteractionEnum? shopperInteraction;
  @override
  ...
  factory _$PaymentRequest3ds2([
    void Function(PaymentRequest3ds2Builder)? updates,
  ]) => (PaymentRequest3ds2Builder()..update(updates))._build();

  _$PaymentRequest3ds2._({
    this.accountInfo,
  ...
  @override
  PaymentRequest3ds2 rebuild(
    void Function(PaymentRequest3ds2Builder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  PaymentRequest3ds2Builder toBuilder() =>
      PaymentRequest3ds2Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PaymentRequest3ds2 &&
        ...
        threeDS2Token == other.threeDS2Token &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, threeDS2Token.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PaymentRequest3ds2')
          ...
          ..add('threeDS2Token', threeDS2Token)
...
class PaymentRequest3ds2Builder
    implements Builder<PaymentRequest3ds2, PaymentRequest3ds2Builder> {
  _$PaymentRequest3ds2? _$v;
  ...
  PaymentRequest3ds2RecurringProcessingModelEnum? _recurringProcessingModel;
  PaymentRequest3ds2RecurringProcessingModelEnum?
  get recurringProcessingModel => _$this._recurringProcessingModel;
  set recurringProcessingModel(
    PaymentRequest3ds2RecurringProcessingModelEnum? recurringProcessingModel,
  ...
  PaymentRequest3ds2ShopperInteractionEnum? _shopperInteraction;
  ...
  String? _threeDS2Token;
  String? get threeDS2Token => _$this._threeDS2Token;
  set threeDS2Token(String? threeDS2Token) =>
      _$this._threeDS2Token = threeDS2Token;
  ...
  PaymentRequest3ds2Builder() {
    PaymentRequest3ds2._defaults(this);
  }

  PaymentRequest3ds2Builder get _$this {
    final $v = _$v;
    if ($v != null) {
      ...
      _threeDS2Token = $v.threeDS2Token;
  ...
  @override
  void replace(PaymentRequest3ds2 other) {
    _$v = other as _$PaymentRequest3ds2;
  }

  @override
  void update(void Function(PaymentRequest3ds2Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PaymentRequest3ds2 build() => _build();

  _$PaymentRequest3ds2 _build() {
    _$PaymentRequest3ds2 _$result;
    try {
      _$result =
          _$v ??
          _$PaymentRequest3ds2._(
