...
part of 'void_pending_refund_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$VoidPendingRefundRequest extends VoidPendingRefundRequest {
  @override
  ...
  factory _$VoidPendingRefundRequest([
    void Function(VoidPendingRefundRequestBuilder)? updates,
  ]) => (VoidPendingRefundRequestBuilder()..update(updates))._build();

  _$VoidPendingRefundRequest._({
    this.additionalData,
  ...
  @override
  VoidPendingRefundRequest rebuild(
    void Function(VoidPendingRefundRequestBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  VoidPendingRefundRequestBuilder toBuilder() =>
      VoidPendingRefundRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VoidPendingRefundRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'VoidPendingRefundRequest')
...
class VoidPendingRefundRequestBuilder
    implements
        Builder<VoidPendingRefundRequest, VoidPendingRefundRequestBuilder> {
  _$VoidPendingRefundRequest? _$v;
  ...
  VoidPendingRefundRequestBuilder() {
    VoidPendingRefundRequest._defaults(this);
  }

  VoidPendingRefundRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(VoidPendingRefundRequest other) {
    _$v = other as _$VoidPendingRefundRequest;
  }

  @override
  void update(void Function(VoidPendingRefundRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  VoidPendingRefundRequest build() => _build();

  _$VoidPendingRefundRequest _build() {
    _$VoidPendingRefundRequest _$result;
    try {
      _$result =
          _$v ??
          _$VoidPendingRefundRequest._(
