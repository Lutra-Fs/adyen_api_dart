...
part 'technical_cancel_request.g.dart';
...
@BuiltValue()
abstract class TechnicalCancelRequest implements Built<TechnicalCancelRequest, TechnicalCancelRequestBuilder> {
  ...
  TechnicalCancelRequest._();

  factory TechnicalCancelRequest([void updates(TechnicalCancelRequestBuilder b)]) = _$TechnicalCancelRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TechnicalCancelRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TechnicalCancelRequest> get serializer => _$TechnicalCancelRequestSerializer();
}

class _$TechnicalCancelRequestSerializer implements PrimitiveSerializer<TechnicalCancelRequest> {
  @override
  final Iterable<Type> types = const [TechnicalCancelRequest, _$TechnicalCancelRequest];

  @override
  final String wireName = r'TechnicalCancelRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TechnicalCancelRequest object, {
  ...
  void _deserializeProperties(
    ...
    required TechnicalCancelRequestBuilder result,
  ...
  @override
  TechnicalCancelRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TechnicalCancelRequestBuilder();
