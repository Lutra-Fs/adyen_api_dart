...
part 'payment_request3ds2.g.dart';
...
@BuiltValue()
abstract class PaymentRequest3ds2 implements Built<PaymentRequest3ds2, PaymentRequest3ds2Builder> {
  ...
  PaymentRequest3ds2RecurringProcessingModelEnum? get recurringProcessingModel;
  ...
  @BuiltValueField(wireName: r'threeDS2Token')
  String? get threeDS2Token;
  ...
  PaymentRequest3ds2._();

  factory PaymentRequest3ds2([void updates(PaymentRequest3ds2Builder b)]) = _$PaymentRequest3ds2;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentRequest3ds2Builder b) => b
      ..threeDSAuthenticationOnly = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentRequest3ds2> get serializer => _$PaymentRequest3ds2Serializer();
}

class _$PaymentRequest3ds2Serializer implements PrimitiveSerializer<PaymentRequest3ds2> {
  @override
  final Iterable<Type> types = const [PaymentRequest3ds2, _$PaymentRequest3ds2];

  @override
  final String wireName = r'PaymentRequest3ds2';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.recurringProcessingModel != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(PaymentRequest3ds2RecurringProcessingModelEnum),
      );
    }
    yield r'reference';
    yield serializers.serialize(
    ...
    if (object.shopperInteraction != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(PaymentRequest3ds2ShopperInteractionEnum),
      );
    }
    ...
    if (object.threeDS2Token != null) {
      yield r'threeDS2Token';
      yield serializers.serialize(
        object.threeDS2Token,
        specifiedType: const FullType(String),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PaymentRequest3ds2Builder result,
      ...
      switch (key) {
        ...
        case r'recurringProcessingModel':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PaymentRequest3ds2RecurringProcessingModelEnum),
          ) as PaymentRequest3ds2RecurringProcessingModelEnum;
        ...
        case r'shopperInteraction':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PaymentRequest3ds2ShopperInteractionEnum),
          ) as PaymentRequest3ds2ShopperInteractionEnum;
        ...
        case r'threeDS2Result':
          ...
          break;
        case r'threeDS2Token':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          ) as String;
          result.threeDS2Token = valueDes;
          break;
  ...
  @override
  PaymentRequest3ds2 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentRequest3ds2Builder();
...
class PaymentRequest3ds2RecurringProcessingModelEnum extends EnumClass {

  /// Defines a recurring payment type. Required when creating a token to store payment details or using stored payment details. Allowed values: * `Subscription` – A transaction for a fixed or variable amount, which follows a fixed schedule. * `CardOnFile` – With a card-on-file (CoF) transaction, card details are stored to enable one-click or omnichannel journeys, or simply to streamline the checkout process. Any subscription not following a fixed schedule is also considered a card-on-file transaction. * `UnscheduledCardOnFile` – An unscheduled card-on-file (UCoF) transaction is a transaction that occurs on a non-fixed schedule and/or have variable amounts. For example, automatic top-ups when a cardholder's balance drops below a certain amount. 
  @BuiltValueEnumConst(wireName: r'CardOnFile')
  static const PaymentRequest3ds2RecurringProcessingModelEnum cardOnFile = _$paymentRequest3ds2RecurringProcessingModelEnum_cardOnFile;
  /// Defines a recurring payment type. Required when creating a token to store payment details or using stored payment details. Allowed values: * `Subscription` – A transaction for a fixed or variable amount, which follows a fixed schedule. * `CardOnFile` – With a card-on-file (CoF) transaction, card details are stored to enable one-click or omnichannel journeys, or simply to streamline the checkout process. Any subscription not following a fixed schedule is also considered a card-on-file transaction. * `UnscheduledCardOnFile` – An unscheduled card-on-file (UCoF) transaction is a transaction that occurs on a non-fixed schedule and/or have variable amounts. For example, automatic top-ups when a cardholder's balance drops below a certain amount. 
  @BuiltValueEnumConst(wireName: r'Subscription')
  static const PaymentRequest3ds2RecurringProcessingModelEnum subscription = _$paymentRequest3ds2RecurringProcessingModelEnum_subscription;
  /// Defines a recurring payment type. Required when creating a token to store payment details or using stored payment details. Allowed values: * `Subscription` – A transaction for a fixed or variable amount, which follows a fixed schedule. * `CardOnFile` – With a card-on-file (CoF) transaction, card details are stored to enable one-click or omnichannel journeys, or simply to streamline the checkout process. Any subscription not following a fixed schedule is also considered a card-on-file transaction. * `UnscheduledCardOnFile` – An unscheduled card-on-file (UCoF) transaction is a transaction that occurs on a non-fixed schedule and/or have variable amounts. For example, automatic top-ups when a cardholder's balance drops below a certain amount. 
  @BuiltValueEnumConst(wireName: r'UnscheduledCardOnFile')
  static const PaymentRequest3ds2RecurringProcessingModelEnum unscheduledCardOnFile = _$paymentRequest3ds2RecurringProcessingModelEnum_unscheduledCardOnFile;
  /// Defines a recurring payment type. Required when creating a token to store payment details or using stored payment details. Allowed values: * `Subscription` – A transaction for a fixed or variable amount, which follows a fixed schedule. * `CardOnFile` – With a card-on-file (CoF) transaction, card details are stored to enable one-click or omnichannel journeys, or simply to streamline the checkout process. Any subscription not following a fixed schedule is also considered a card-on-file transaction. * `UnscheduledCardOnFile` – An unscheduled card-on-file (UCoF) transaction is a transaction that occurs on a non-fixed schedule and/or have variable amounts. For example, automatic top-ups when a cardholder's balance drops below a certain amount. 
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const PaymentRequest3ds2RecurringProcessingModelEnum unknownDefaultOpenApi = _$paymentRequest3ds2RecurringProcessingModelEnum_unknownDefaultOpenApi;

  static Serializer<PaymentRequest3ds2RecurringProcessingModelEnum> get serializer => _$paymentRequest3ds2RecurringProcessingModelEnumSerializer;

  const PaymentRequest3ds2RecurringProcessingModelEnum._(String name): super(name);

  static BuiltSet<PaymentRequest3ds2RecurringProcessingModelEnum> get values => _$paymentRequest3ds2RecurringProcessingModelEnumValues;
  static PaymentRequest3ds2RecurringProcessingModelEnum valueOf(String name) => _$paymentRequest3ds2RecurringProcessingModelEnumValueOf(name);
}

class PaymentRequest3ds2ShopperInteractionEnum extends EnumClass {

  /// Specifies the sales channel, through which the shopper gives their card details, and whether the shopper is a returning customer. For the web service API, Adyen assumes Ecommerce shopper interaction by default.  This field has the following possible values: * `Ecommerce` - Online transactions where the cardholder is present (online). For better authorisation rates, we recommend sending the card security code (CSC) along with the request. * `ContAuth` - Card on file and/or subscription transactions, where the cardholder is known to the merchant (returning customer). If the shopper is present (online), you can supply also the CSC to improve authorisation (one-click payment). * `Moto` - Mail-order and telephone-order transactions where the shopper is in contact with the merchant via email or telephone. * `POS` - Point-of-sale transactions where the shopper is physically present to make a payment using a secure payment terminal.
  @BuiltValueEnumConst(wireName: r'Ecommerce')
  static const PaymentRequest3ds2ShopperInteractionEnum ecommerce = _$paymentRequest3ds2ShopperInteractionEnum_ecommerce;
  /// Specifies the sales channel, through which the shopper gives their card details, and whether the shopper is a returning customer. For the web service API, Adyen assumes Ecommerce shopper interaction by default.  This field has the following possible values: * `Ecommerce` - Online transactions where the cardholder is present (online). For better authorisation rates, we recommend sending the card security code (CSC) along with the request. * `ContAuth` - Card on file and/or subscription transactions, where the cardholder is known to the merchant (returning customer). If the shopper is present (online), you can supply also the CSC to improve authorisation (one-click payment). * `Moto` - Mail-order and telephone-order transactions where the shopper is in contact with the merchant via email or telephone. * `POS` - Point-of-sale transactions where the shopper is physically present to make a payment using a secure payment terminal.
  @BuiltValueEnumConst(wireName: r'ContAuth')
  static const PaymentRequest3ds2ShopperInteractionEnum contAuth = _$paymentRequest3ds2ShopperInteractionEnum_contAuth;
  /// Specifies the sales channel, through which the shopper gives their card details, and whether the shopper is a returning customer. For the web service API, Adyen assumes Ecommerce shopper interaction by default.  This field has the following possible values: * `Ecommerce` - Online transactions where the cardholder is present (online). For better authorisation rates, we recommend sending the card security code (CSC) along with the request. * `ContAuth` - Card on file and/or subscription transactions, where the cardholder is known to the merchant (returning customer). If the shopper is present (online), you can supply also the CSC to improve authorisation (one-click payment). * `Moto` - Mail-order and telephone-order transactions where the shopper is in contact with the merchant via email or telephone. * `POS` - Point-of-sale transactions where the shopper is physically present to make a payment using a secure payment terminal.
  @BuiltValueEnumConst(wireName: r'Moto')
  static const PaymentRequest3ds2ShopperInteractionEnum moto = _$paymentRequest3ds2ShopperInteractionEnum_moto;
  /// Specifies the sales channel, through which the shopper gives their card details, and whether the shopper is a returning customer. For the web service API, Adyen assumes Ecommerce shopper interaction by default.  This field has the following possible values: * `Ecommerce` - Online transactions where the cardholder is present (online). For better authorisation rates, we recommend sending the card security code (CSC) along with the request. * `ContAuth` - Card on file and/or subscription transactions, where the cardholder is known to the merchant (returning customer). If the shopper is present (online), you can supply also the CSC to improve authorisation (one-click payment). * `Moto` - Mail-order and telephone-order transactions where the shopper is in contact with the merchant via email or telephone. * `POS` - Point-of-sale transactions where the shopper is physically present to make a payment using a secure payment terminal.
  @BuiltValueEnumConst(wireName: r'POS')
  static const PaymentRequest3ds2ShopperInteractionEnum POS = _$paymentRequest3ds2ShopperInteractionEnum_POS;
  /// Specifies the sales channel, through which the shopper gives their card details, and whether the shopper is a returning customer. For the web service API, Adyen assumes Ecommerce shopper interaction by default.  This field has the following possible values: * `Ecommerce` - Online transactions where the cardholder is present (online). For better authorisation rates, we recommend sending the card security code (CSC) along with the request. * `ContAuth` - Card on file and/or subscription transactions, where the cardholder is known to the merchant (returning customer). If the shopper is present (online), you can supply also the CSC to improve authorisation (one-click payment). * `Moto` - Mail-order and telephone-order transactions where the shopper is in contact with the merchant via email or telephone. * `POS` - Point-of-sale transactions where the shopper is physically present to make a payment using a secure payment terminal.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const PaymentRequest3ds2ShopperInteractionEnum unknownDefaultOpenApi = _$paymentRequest3ds2ShopperInteractionEnum_unknownDefaultOpenApi;

  static Serializer<PaymentRequest3ds2ShopperInteractionEnum> get serializer => _$paymentRequest3ds2ShopperInteractionEnumSerializer;

  const PaymentRequest3ds2ShopperInteractionEnum._(String name): super(name);

  static BuiltSet<PaymentRequest3ds2ShopperInteractionEnum> get values => _$paymentRequest3ds2ShopperInteractionEnumValues;
  static PaymentRequest3ds2ShopperInteractionEnum valueOf(String name) => _$paymentRequest3ds2ShopperInteractionEnumValueOf(name);
}
