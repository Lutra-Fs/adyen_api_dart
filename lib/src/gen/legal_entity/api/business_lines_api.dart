...
class BusinessLinesApi {
  ...
  const BusinessLinesApi(this._dio, this._serializers);
  ...
  ///
  /// Parameters:
  /// * [id] - The unique identifier of the business line to be deleted.
  ...
  Future<Response<void>> deleteBusinessLinesId({ 
    required String id,
    ...
    final _path = r'/businessLines/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BusinessLine] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BusinessLine>> getBusinessLinesId({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [BusinessLine] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BusinessLine>> patchBusinessLinesId({ 
    required String id,
    ...
    try {
      const _type = FullType(BusinessLineInfoUpdate);
      _bodyData = businessLineInfoUpdate == null ? null : _serializers.serialize(businessLineInfoUpdate, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BusinessLine] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BusinessLine>> postBusinessLines({ 
    ...
    try {
      const _type = FullType(BusinessLineInfo);
      _bodyData = businessLineInfo == null ? null : _serializers.serialize(businessLineInfo, specifiedType: _type);
