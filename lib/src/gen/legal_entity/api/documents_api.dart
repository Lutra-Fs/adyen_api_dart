...
class DocumentsApi {
  ...
  Future<Response<void>> deleteDocumentsId({ 
    required String id,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Document>> getDocumentsId({ 
    required String id,
    bool? skipContent,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (skipContent != null) r'skipContent': encodeQueryParameter(_serializers, skipContent, const FullType(bool)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [Document] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Document>> patchDocumentsId({ 
    required String id,
    ...
    try {
      ...
      _bodyData = document == null ? null : _serializers.serialize(document, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Document] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Document>> postDocuments({ 
    String? xRequestedVerificationCode,
    Document? document,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
