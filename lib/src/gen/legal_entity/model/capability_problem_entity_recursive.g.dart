...
const CapabilityProblemEntityRecursiveTypeEnum
_$capabilityProblemEntityRecursiveTypeEnum_product =
    const CapabilityProblemEntityRecursiveTypeEnum._('product');
const CapabilityProblemEntityRecursiveTypeEnum
...
_$capabilityProblemEntityRecursiveTypeEnumValueOf(String name) {
  switch (name) {
    ...
    case 'product':
      return _$capabilityProblemEntityRecursiveTypeEnum_product;
