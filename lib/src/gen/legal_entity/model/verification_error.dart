...
abstract class VerificationError implements Built<VerificationError, VerificationErrorBuilder> {
  ...
  // enum typeEnum {  dataMissing,  dataReview,  invalidInput,  pendingStatus,  rejected,  };
...
class VerificationErrorTypeEnum extends EnumClass {
  ...
  static const VerificationErrorTypeEnum rejected = _$verificationErrorTypeEnum_rejected;
  /// The type of error.  Possible values: *  **invalidInput** *  **dataMissing** *  **pendingStatus** *  **rejected** *  **dataReview**  
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
