...
part of 'transfer_funds_notification.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$TransferFundsNotification extends TransferFundsNotification {
  @override
  final TransferFundsNotificationContent? content;
  @override
  ...
  factory _$TransferFundsNotification([
    void Function(TransferFundsNotificationBuilder)? updates,
  ]) => (TransferFundsNotificationBuilder()..update(updates))._build();

  _$TransferFundsNotification._({
    this.content,
    this.error,
  ...
  @override
  TransferFundsNotification rebuild(
    void Function(TransferFundsNotificationBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  TransferFundsNotificationBuilder toBuilder() =>
      TransferFundsNotificationBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TransferFundsNotification &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'TransferFundsNotification')
          ..add('content', content)
          ..add('error', error)
...
class TransferFundsNotificationBuilder
    implements
        Builder<TransferFundsNotification, TransferFundsNotificationBuilder> {
  _$TransferFundsNotification? _$v;

  TransferFundsNotificationContentBuilder? _content;
  ...
  TransferFundsNotificationBuilder() {
    TransferFundsNotification._defaults(this);
  }

  TransferFundsNotificationBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(TransferFundsNotification other) {
    _$v = other as _$TransferFundsNotification;
  }

  @override
  void update(void Function(TransferFundsNotificationBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  TransferFundsNotification build() => _build();

  _$TransferFundsNotification _build() {
    _$TransferFundsNotification _$result;
    try {
      _$result =
          _$v ??
          _$TransferFundsNotification._(
