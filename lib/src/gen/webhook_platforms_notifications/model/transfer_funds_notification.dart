...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/transfer_funds_notification_content.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'transfer_funds_notification.g.dart';

/// TransferFundsNotification
///
/// Properties:
/// * [content] - Details of the fund transfer.
...
@BuiltValue()
abstract class TransferFundsNotification implements Built<TransferFundsNotification, TransferFundsNotificationBuilder> {
  ...
  TransferFundsNotification._();

  factory TransferFundsNotification([void updates(TransferFundsNotificationBuilder b)]) = _$TransferFundsNotification;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TransferFundsNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TransferFundsNotification> get serializer => _$TransferFundsNotificationSerializer();
}

class _$TransferFundsNotificationSerializer implements PrimitiveSerializer<TransferFundsNotification> {
  @override
  final Iterable<Type> types = const [TransferFundsNotification, _$TransferFundsNotification];

  @override
  final String wireName = r'TransferFundsNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(TransferFundsNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required TransferFundsNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(TransferFundsNotificationContent),
          ) as TransferFundsNotificationContent;
  ...
  @override
  TransferFundsNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TransferFundsNotificationBuilder();
