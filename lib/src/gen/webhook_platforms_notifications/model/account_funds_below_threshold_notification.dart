...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/account_funds_below_threshold_notification_content.dart';
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/notification_error_container.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'account_funds_below_threshold_notification.g.dart';

/// AccountFundsBelowThresholdNotification
///
/// Properties:
/// * [content] - Details of the liable account with funds under threshold.
...
@BuiltValue()
abstract class AccountFundsBelowThresholdNotification implements Built<AccountFundsBelowThresholdNotification, AccountFundsBelowThresholdNotificationBuilder> {
  ...
  AccountFundsBelowThresholdNotification._();
  ...
  static void _defaults(AccountFundsBelowThresholdNotificationBuilder b) => b;
...
class _$AccountFundsBelowThresholdNotificationSerializer implements PrimitiveSerializer<AccountFundsBelowThresholdNotification> {
  @override
  final Iterable<Type> types = const [AccountFundsBelowThresholdNotification, _$AccountFundsBelowThresholdNotification];

  @override
  final String wireName = r'AccountFundsBelowThresholdNotification';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccountFundsBelowThresholdNotification object, {
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(AccountFundsBelowThresholdNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required AccountFundsBelowThresholdNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(AccountFundsBelowThresholdNotificationContent),
          ) as AccountFundsBelowThresholdNotificationContent;
  ...
  @override
  AccountFundsBelowThresholdNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountFundsBelowThresholdNotificationBuilder();
