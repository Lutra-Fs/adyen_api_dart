...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/payment_failure_notification_content.dart';
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/notification_error_container.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'payment_failure_notification.g.dart';

/// PaymentFailureNotification
///
/// Properties:
/// * [content] - The details of the payment failure.
...
@BuiltValue()
abstract class PaymentFailureNotification implements Built<PaymentFailureNotification, PaymentFailureNotificationBuilder> {
  ...
  PaymentFailureNotification._();

  factory PaymentFailureNotification([void updates(PaymentFailureNotificationBuilder b)]) = _$PaymentFailureNotification;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentFailureNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentFailureNotification> get serializer => _$PaymentFailureNotificationSerializer();
}

class _$PaymentFailureNotificationSerializer implements PrimitiveSerializer<PaymentFailureNotification> {
  @override
  final Iterable<Type> types = const [PaymentFailureNotification, _$PaymentFailureNotification];

  @override
  final String wireName = r'PaymentFailureNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(PaymentFailureNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PaymentFailureNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PaymentFailureNotificationContent),
          ) as PaymentFailureNotificationContent;
  ...
  @override
  PaymentFailureNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentFailureNotificationBuilder();
