...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/scheduled_refunds_notification_content.dart';
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/notification_error_container.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'scheduled_refunds_notification.g.dart';

/// ScheduledRefundsNotification
///
/// Properties:
/// * [content] - Details of the scheduling of the refunds.
...
@BuiltValue()
abstract class ScheduledRefundsNotification implements Built<ScheduledRefundsNotification, ScheduledRefundsNotificationBuilder> {
  ...
  ScheduledRefundsNotification._();

  factory ScheduledRefundsNotification([void updates(ScheduledRefundsNotificationBuilder b)]) = _$ScheduledRefundsNotification;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ScheduledRefundsNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ScheduledRefundsNotification> get serializer => _$ScheduledRefundsNotificationSerializer();
}

class _$ScheduledRefundsNotificationSerializer implements PrimitiveSerializer<ScheduledRefundsNotification> {
  @override
  final Iterable<Type> types = const [ScheduledRefundsNotification, _$ScheduledRefundsNotification];

  @override
  final String wireName = r'ScheduledRefundsNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(ScheduledRefundsNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required ScheduledRefundsNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ScheduledRefundsNotificationContent),
          ) as ScheduledRefundsNotificationContent;
  ...
  @override
  ScheduledRefundsNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ScheduledRefundsNotificationBuilder();
