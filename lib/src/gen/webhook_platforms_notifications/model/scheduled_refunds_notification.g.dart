...
part of 'scheduled_refunds_notification.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ScheduledRefundsNotification extends ScheduledRefundsNotification {
  @override
  final ScheduledRefundsNotificationContent? content;
  @override
  ...
  factory _$ScheduledRefundsNotification([
    void Function(ScheduledRefundsNotificationBuilder)? updates,
  ]) => (ScheduledRefundsNotificationBuilder()..update(updates))._build();

  _$ScheduledRefundsNotification._({
    this.content,
    this.error,
  ...
  @override
  ScheduledRefundsNotification rebuild(
    void Function(ScheduledRefundsNotificationBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  ScheduledRefundsNotificationBuilder toBuilder() =>
      ScheduledRefundsNotificationBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ScheduledRefundsNotification &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ScheduledRefundsNotification')
          ..add('content', content)
          ..add('error', error)
...
class ScheduledRefundsNotificationBuilder
    implements
        Builder<
          ScheduledRefundsNotification,
          ScheduledRefundsNotificationBuilder
        > {
  _$ScheduledRefundsNotification? _$v;

  ScheduledRefundsNotificationContentBuilder? _content;
  ...
  ScheduledRefundsNotificationBuilder() {
    ScheduledRefundsNotification._defaults(this);
  }

  ScheduledRefundsNotificationBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ScheduledRefundsNotification other) {
    _$v = other as _$ScheduledRefundsNotification;
  }

  @override
  void update(void Function(ScheduledRefundsNotificationBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ScheduledRefundsNotification build() => _build();

  _$ScheduledRefundsNotification _build() {
    _$ScheduledRefundsNotification _$result;
    try {
      _$result =
          _$v ??
          _$ScheduledRefundsNotification._(
            ...
            eventDate: BuiltValueNullFieldError.checkNotNull(
              eventDate,
              r'ScheduledRefundsNotification',
              'eventDate',
            ),
