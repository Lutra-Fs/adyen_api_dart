...
part of 'compensate_negative_balance_notification.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CompensateNegativeBalanceNotification
    extends CompensateNegativeBalanceNotification {
  @override
  final CompensateNegativeBalanceNotificationContent? content;
  @override
  ...
  factory _$CompensateNegativeBalanceNotification([
    void Function(CompensateNegativeBalanceNotificationBuilder)? updates,
  ]) => (CompensateNegativeBalanceNotificationBuilder()..update(updates))
      ._build();

  _$CompensateNegativeBalanceNotification._({
    this.content,
    this.error,
  ...
  @override
  CompensateNegativeBalanceNotification rebuild(
    void Function(CompensateNegativeBalanceNotificationBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  CompensateNegativeBalanceNotificationBuilder toBuilder() =>
      CompensateNegativeBalanceNotificationBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CompensateNegativeBalanceNotification &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'CompensateNegativeBalanceNotification',
          )
          ..add('content', content)
          ..add('error', error)
...
class CompensateNegativeBalanceNotificationBuilder
    implements
        Builder<
          CompensateNegativeBalanceNotification,
          CompensateNegativeBalanceNotificationBuilder
        > {
  _$CompensateNegativeBalanceNotification? _$v;

  CompensateNegativeBalanceNotificationContentBuilder? _content;
  ...
  CompensateNegativeBalanceNotificationBuilder() {
    CompensateNegativeBalanceNotification._defaults(this);
  }

  CompensateNegativeBalanceNotificationBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(CompensateNegativeBalanceNotification other) {
    _$v = other as _$CompensateNegativeBalanceNotification;
  }
  ...
  @override
  CompensateNegativeBalanceNotification build() => _build();

  _$CompensateNegativeBalanceNotification _build() {
    _$CompensateNegativeBalanceNotification _$result;
    try {
      _$result =
          _$v ??
          _$CompensateNegativeBalanceNotification._(
