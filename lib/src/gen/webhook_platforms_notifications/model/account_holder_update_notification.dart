...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/update_account_holder_response.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'account_holder_update_notification.g.dart';

/// AccountHolderUpdateNotification
///
/// Properties:
/// * [content] - The details of the Account Holder update.
...
@BuiltValue()
abstract class AccountHolderUpdateNotification implements Built<AccountHolderUpdateNotification, AccountHolderUpdateNotificationBuilder> {
  ...
  AccountHolderUpdateNotification._();
  ...
  static void _defaults(AccountHolderUpdateNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountHolderUpdateNotification> get serializer => _$AccountHolderUpdateNotificationSerializer();
}

class _$AccountHolderUpdateNotificationSerializer implements PrimitiveSerializer<AccountHolderUpdateNotification> {
  @override
  final Iterable<Type> types = const [AccountHolderUpdateNotification, _$AccountHolderUpdateNotification];

  @override
  final String wireName = r'AccountHolderUpdateNotification';
  ...
  void _deserializeProperties(
    ...
    required AccountHolderUpdateNotificationBuilder result,
  ...
  @override
  AccountHolderUpdateNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountHolderUpdateNotificationBuilder();
