...
part of 'account_holder_store_status_change_notification.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AccountHolderStoreStatusChangeNotification
    extends AccountHolderStoreStatusChangeNotification {
  @override
  final AccountHolderStoreStatusChangeNotificationContent? content;
  @override
  ...
  factory _$AccountHolderStoreStatusChangeNotification([
    void Function(AccountHolderStoreStatusChangeNotificationBuilder)? updates,
  ]) => (AccountHolderStoreStatusChangeNotificationBuilder()..update(updates))
      ._build();

  _$AccountHolderStoreStatusChangeNotification._({
    this.content,
    this.error,
  ...
  @override
  AccountHolderStoreStatusChangeNotification rebuild(
    void Function(AccountHolderStoreStatusChangeNotificationBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  AccountHolderStoreStatusChangeNotificationBuilder toBuilder() =>
      AccountHolderStoreStatusChangeNotificationBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AccountHolderStoreStatusChangeNotification &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'AccountHolderStoreStatusChangeNotification',
          )
          ..add('content', content)
          ..add('error', error)
...
class AccountHolderStoreStatusChangeNotificationBuilder
    implements
        Builder<
          AccountHolderStoreStatusChangeNotification,
          AccountHolderStoreStatusChangeNotificationBuilder
        > {
  _$AccountHolderStoreStatusChangeNotification? _$v;

  AccountHolderStoreStatusChangeNotificationContentBuilder? _content;
  ...
  AccountHolderStoreStatusChangeNotificationBuilder() {
    AccountHolderStoreStatusChangeNotification._defaults(this);
  }

  AccountHolderStoreStatusChangeNotificationBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AccountHolderStoreStatusChangeNotification other) {
    _$v = other as _$AccountHolderStoreStatusChangeNotification;
  }
  ...
  @override
  AccountHolderStoreStatusChangeNotification build() => _build();

  _$AccountHolderStoreStatusChangeNotification _build() {
    _$AccountHolderStoreStatusChangeNotification _$result;
    try {
      _$result =
          _$v ??
          _$AccountHolderStoreStatusChangeNotification._(
