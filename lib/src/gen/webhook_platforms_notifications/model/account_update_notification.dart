...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/update_account_response.dart';
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/notification_error_container.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'account_update_notification.g.dart';
...
@BuiltValue()
abstract class AccountUpdateNotification implements Built<AccountUpdateNotification, AccountUpdateNotificationBuilder> {
  ...
  AccountUpdateNotification._();

  factory AccountUpdateNotification([void updates(AccountUpdateNotificationBuilder b)]) = _$AccountUpdateNotification;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccountUpdateNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountUpdateNotification> get serializer => _$AccountUpdateNotificationSerializer();
}

class _$AccountUpdateNotificationSerializer implements PrimitiveSerializer<AccountUpdateNotification> {
  @override
  final Iterable<Type> types = const [AccountUpdateNotification, _$AccountUpdateNotification];

  @override
  final String wireName = r'AccountUpdateNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(UpdateAccountResponse),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required AccountUpdateNotificationBuilder result,
  ...
  @override
  AccountUpdateNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountUpdateNotificationBuilder();
