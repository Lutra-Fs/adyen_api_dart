...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/compensate_negative_balance_notification_content.dart';
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/notification_error_container.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'compensate_negative_balance_notification.g.dart';
...
@BuiltValue()
abstract class CompensateNegativeBalanceNotification implements Built<CompensateNegativeBalanceNotification, CompensateNegativeBalanceNotificationBuilder> {
  ...
  CompensateNegativeBalanceNotification._();

  factory CompensateNegativeBalanceNotification([void updates(CompensateNegativeBalanceNotificationBuilder b)]) = _$CompensateNegativeBalanceNotification;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CompensateNegativeBalanceNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CompensateNegativeBalanceNotification> get serializer => _$CompensateNegativeBalanceNotificationSerializer();
}

class _$CompensateNegativeBalanceNotificationSerializer implements PrimitiveSerializer<CompensateNegativeBalanceNotification> {
  @override
  final Iterable<Type> types = const [CompensateNegativeBalanceNotification, _$CompensateNegativeBalanceNotification];

  @override
  final String wireName = r'CompensateNegativeBalanceNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(CompensateNegativeBalanceNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required CompensateNegativeBalanceNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(CompensateNegativeBalanceNotificationContent),
          ) as CompensateNegativeBalanceNotificationContent;
  ...
  @override
  CompensateNegativeBalanceNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CompensateNegativeBalanceNotificationBuilder();
