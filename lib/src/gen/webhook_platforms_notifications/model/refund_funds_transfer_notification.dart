...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/refund_funds_transfer_notification_content.dart';
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/notification_error_container.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'refund_funds_transfer_notification.g.dart';

/// RefundFundsTransferNotification
///
/// Properties:
/// * [content] - Details of the fund transfer refund.
...
@BuiltValue()
abstract class RefundFundsTransferNotification implements Built<RefundFundsTransferNotification, RefundFundsTransferNotificationBuilder> {
  ...
  RefundFundsTransferNotification._();

  factory RefundFundsTransferNotification([void updates(RefundFundsTransferNotificationBuilder b)]) = _$RefundFundsTransferNotification;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RefundFundsTransferNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RefundFundsTransferNotification> get serializer => _$RefundFundsTransferNotificationSerializer();
}

class _$RefundFundsTransferNotificationSerializer implements PrimitiveSerializer<RefundFundsTransferNotification> {
  @override
  final Iterable<Type> types = const [RefundFundsTransferNotification, _$RefundFundsTransferNotification];

  @override
  final String wireName = r'RefundFundsTransferNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(RefundFundsTransferNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required RefundFundsTransferNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(RefundFundsTransferNotificationContent),
          ) as RefundFundsTransferNotificationContent;
  ...
  @override
  RefundFundsTransferNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RefundFundsTransferNotificationBuilder();
