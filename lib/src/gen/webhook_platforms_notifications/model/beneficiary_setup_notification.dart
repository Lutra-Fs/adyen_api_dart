...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/beneficiary_setup_notification_content.dart';
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/notification_error_container.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'beneficiary_setup_notification.g.dart';

/// BeneficiarySetupNotification
///
/// Properties:
/// * [content] - Details of the beneficiary setup.
...
@BuiltValue()
abstract class BeneficiarySetupNotification implements Built<BeneficiarySetupNotification, BeneficiarySetupNotificationBuilder> {
  /// Details of the beneficiary setup.
  @BuiltValueField(wireName: r'content')
  BeneficiarySetupNotificationContent? get content;
  ...
  BeneficiarySetupNotification._();

  factory BeneficiarySetupNotification([void updates(BeneficiarySetupNotificationBuilder b)]) = _$BeneficiarySetupNotification;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BeneficiarySetupNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BeneficiarySetupNotification> get serializer => _$BeneficiarySetupNotificationSerializer();
}

class _$BeneficiarySetupNotificationSerializer implements PrimitiveSerializer<BeneficiarySetupNotification> {
  @override
  final Iterable<Type> types = const [BeneficiarySetupNotification, _$BeneficiarySetupNotification];

  @override
  final String wireName = r'BeneficiarySetupNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(BeneficiarySetupNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required BeneficiarySetupNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BeneficiarySetupNotificationContent),
          ) as BeneficiarySetupNotificationContent;
  ...
  @override
  BeneficiarySetupNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BeneficiarySetupNotificationBuilder();
