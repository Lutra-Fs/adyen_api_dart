...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/account_holder_payout_notification_content.dart';
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/notification_error_container.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'account_holder_payout_notification.g.dart';

/// AccountHolderPayoutNotification
///
/// Properties:
/// * [content] - Details of the payout to the Account Holder.
...
@BuiltValue()
abstract class AccountHolderPayoutNotification implements Built<AccountHolderPayoutNotification, AccountHolderPayoutNotificationBuilder> {
  ...
  AccountHolderPayoutNotification._();
  ...
  static void _defaults(AccountHolderPayoutNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountHolderPayoutNotification> get serializer => _$AccountHolderPayoutNotificationSerializer();
}

class _$AccountHolderPayoutNotificationSerializer implements PrimitiveSerializer<AccountHolderPayoutNotification> {
  @override
  final Iterable<Type> types = const [AccountHolderPayoutNotification, _$AccountHolderPayoutNotification];

  @override
  final String wireName = r'AccountHolderPayoutNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(AccountHolderPayoutNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required AccountHolderPayoutNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(AccountHolderPayoutNotificationContent),
          ) as AccountHolderPayoutNotificationContent;
  ...
  @override
  AccountHolderPayoutNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountHolderPayoutNotificationBuilder();
