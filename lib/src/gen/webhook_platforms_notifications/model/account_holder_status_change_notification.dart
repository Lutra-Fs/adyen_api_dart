...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/account_holder_status_change_notification_content.dart';
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/notification_error_container.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'account_holder_status_change_notification.g.dart';

/// AccountHolderStatusChangeNotification
///
/// Properties:
/// * [content] - The details of the Account Holder status change.
...
@BuiltValue()
abstract class AccountHolderStatusChangeNotification implements Built<AccountHolderStatusChangeNotification, AccountHolderStatusChangeNotificationBuilder> {
  /// The details of the Account Holder status change.
  @BuiltValueField(wireName: r'content')
  AccountHolderStatusChangeNotificationContent? get content;
  ...
  AccountHolderStatusChangeNotification._();
  ...
  static void _defaults(AccountHolderStatusChangeNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountHolderStatusChangeNotification> get serializer => _$AccountHolderStatusChangeNotificationSerializer();
}

class _$AccountHolderStatusChangeNotificationSerializer implements PrimitiveSerializer<AccountHolderStatusChangeNotification> {
  @override
  final Iterable<Type> types = const [AccountHolderStatusChangeNotification, _$AccountHolderStatusChangeNotification];

  @override
  final String wireName = r'AccountHolderStatusChangeNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(AccountHolderStatusChangeNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required AccountHolderStatusChangeNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(AccountHolderStatusChangeNotificationContent),
          ) as AccountHolderStatusChangeNotificationContent;
  ...
  @override
  AccountHolderStatusChangeNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountHolderStatusChangeNotificationBuilder();
