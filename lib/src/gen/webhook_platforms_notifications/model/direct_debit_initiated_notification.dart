...
import 'package:adyen_api/src/gen/webhook_platforms_notifications/model/direct_debit_initiated_notification_content.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'direct_debit_initiated_notification.g.dart';

/// DirectDebitInitiatedNotification
///
/// Properties:
/// * [content] - Details of the direct debit.
...
@BuiltValue()
abstract class DirectDebitInitiatedNotification implements Built<DirectDebitInitiatedNotification, DirectDebitInitiatedNotificationBuilder> {
  /// Details of the direct debit.
  @BuiltValueField(wireName: r'content')
  DirectDebitInitiatedNotificationContent? get content;
  ...
  DirectDebitInitiatedNotification._();

  factory DirectDebitInitiatedNotification([void updates(DirectDebitInitiatedNotificationBuilder b)]) = _$DirectDebitInitiatedNotification;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DirectDebitInitiatedNotificationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DirectDebitInitiatedNotification> get serializer => _$DirectDebitInitiatedNotificationSerializer();
}

class _$DirectDebitInitiatedNotificationSerializer implements PrimitiveSerializer<DirectDebitInitiatedNotification> {
  @override
  final Iterable<Type> types = const [DirectDebitInitiatedNotification, _$DirectDebitInitiatedNotification];

  @override
  final String wireName = r'DirectDebitInitiatedNotification';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(DirectDebitInitiatedNotificationContent),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required DirectDebitInitiatedNotificationBuilder result,
      ...
      switch (key) {
        case r'content':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(DirectDebitInitiatedNotificationContent),
          ) as DirectDebitInitiatedNotificationContent;
  ...
  @override
  DirectDebitInitiatedNotification deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DirectDebitInitiatedNotificationBuilder();
