...
class AccountsApi {
  ...
  Future<Response<NotificationResponse>> postACCOUNTCLOSED({ 
    ...
    try {
      const _type = FullType(AccountCloseNotification);
      _bodyData = accountCloseNotification == null ? null : _serializers.serialize(accountCloseNotification, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationResponse>> postACCOUNTCREATED({ 
    ...
    try {
      const _type = FullType(AccountCreateNotification);
      _bodyData = accountCreateNotification == null ? null : _serializers.serialize(accountCreateNotification, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationResponse>> postACCOUNTUPDATED({ 
    ...
    try {
      const _type = FullType(AccountUpdateNotification);
      _bodyData = accountUpdateNotification == null ? null : _serializers.serialize(accountUpdateNotification, specifiedType: _type);
