...
class AccountHoldersApi {
  ...
  Future<Response<NotificationResponse>> postACCOUNTHOLDERCREATED({ 
    ...
    final _path = r'/ACCOUNT_HOLDER_CREATED';
    ...
    try {
      const _type = FullType(AccountHolderCreateNotification);
      _bodyData = accountHolderCreateNotification == null ? null : _serializers.serialize(accountHolderCreateNotification, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationResponse>> postACCOUNTHOLDERSTATUSCHANGE({ 
    ...
    final _path = r'/ACCOUNT_HOLDER_STATUS_CHANGE';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AccountHolderStatusChangeNotification);
      _bodyData = accountHolderStatusChangeNotification == null ? null : _serializers.serialize(accountHolderStatusChangeNotification, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationResponse>> postACCOUNTHOLDERSTORESTATUSCHANGE({ 
    ...
    final _path = r'/ACCOUNT_HOLDER_STORE_STATUS_CHANGE';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AccountHolderStoreStatusChangeNotification);
      _bodyData = accountHolderStoreStatusChangeNotification == null ? null : _serializers.serialize(accountHolderStoreStatusChangeNotification, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationResponse>> postACCOUNTHOLDERUPCOMINGDEADLINE({ 
    ...
    final _path = r'/ACCOUNT_HOLDER_UPCOMING_DEADLINE';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AccountHolderUpcomingDeadlineNotification);
      _bodyData = accountHolderUpcomingDeadlineNotification == null ? null : _serializers.serialize(accountHolderUpcomingDeadlineNotification, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationResponse>> postACCOUNTHOLDERUPDATED({ 
    ...
    final _path = r'/ACCOUNT_HOLDER_UPDATED';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AccountHolderUpdateNotification);
      _bodyData = accountHolderUpdateNotification == null ? null : _serializers.serialize(accountHolderUpdateNotification, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationResponse>> postACCOUNTHOLDERVERIFICATION({ 
    ...
    final _path = r'/ACCOUNT_HOLDER_VERIFICATION';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AccountHolderVerificationNotification);
      _bodyData = accountHolderVerificationNotification == null ? null : _serializers.serialize(accountHolderVerificationNotification, specifiedType: _type);
