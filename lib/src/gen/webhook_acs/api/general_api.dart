...
import '{import&#x3D;model.AuthenticationNotificationRequest, classname&#x3D;AuthenticationNotificationRequest}';
...
class GeneralApi {
  ...
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformAuthenticationCreated({ 
    ...
    final _path = r'/balancePlatform.authentication.created';
    ...
    try {
      const _type = FullType(AuthenticationNotificationRequest);
      _bodyData = authenticationNotificationRequest == null ? null : _serializers.serialize(authenticationNotificationRequest, specifiedType: _type);
