...
class GeneralApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateSessionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateSessionResponse>> postSessions({ 
    ...
    try {
      ...
      _bodyData = createSessionRequest == null ? null : _serializers.serialize(createSessionRequest, specifiedType: _type);
    ...
    CreateSessionResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateSessionResponse),
