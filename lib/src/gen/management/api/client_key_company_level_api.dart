...
class ClientKeyCompanyLevelApi {
  ...
  const ClientKeyCompanyLevelApi(this._dio, this._serializers);
  ...
  Future<Response<GenerateClientKeyResponse>> postCompaniesCompanyIdApiCredentialsApiCredentialIdGenerateClientKey({ 
    ...
    final _path = r'/companies/{companyId}/apiCredentials/{apiCredentialId}/generateClientKey'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString()).replaceAll('{' r'apiCredentialId' '}', encodeQueryParameter(_serializers, apiCredentialId, const FullType(String)).toString());
