...
class WebhooksMerchantLevelApi {
  ...
  const WebhooksMerchantLevelApi(this._dio, this._serializers);
  ...
  Future<Response<void>> deleteMerchantsMerchantIdWebhooksWebhookId({ 
    ...
    final _path = r'/merchants/{merchantId}/webhooks/{webhookId}'.replaceAll('{' r'merchantId' '}', encodeQueryParameter(_serializers, merchantId, const FullType(String)).toString()).replaceAll('{' r'webhookId' '}', encodeQueryParameter(_serializers, webhookId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListWebhooksResponse>> getMerchantsMerchantIdWebhooks({ 
    required String merchantId,
    int? pageNumber,
    int? pageSize,
    CancelToken? cancelToken,
    ...
    final _path = r'/merchants/{merchantId}/webhooks'.replaceAll('{' r'merchantId' '}', encodeQueryParameter(_serializers, merchantId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Webhook>> getMerchantsMerchantIdWebhooksWebhookId({ 
    required String merchantId,
    required String webhookId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Webhook] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Webhook>> patchMerchantsMerchantIdWebhooksWebhookId({ 
    required String merchantId,
    required String webhookId,
    ...
    try {
      const _type = FullType(UpdateMerchantWebhookRequest);
      _bodyData = updateMerchantWebhookRequest == null ? null : _serializers.serialize(updateMerchantWebhookRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Webhook] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Webhook>> postMerchantsMerchantIdWebhooks({ 
    required String merchantId,
    ...
    try {
      const _type = FullType(CreateMerchantWebhookRequest);
      _bodyData = createMerchantWebhookRequest == null ? null : _serializers.serialize(createMerchantWebhookRequest, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenerateHmacKeyResponse>> postMerchantsMerchantIdWebhooksWebhookIdGenerateHmac({ 
    required String merchantId,
    required String webhookId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/merchants/{merchantId}/webhooks/{webhookId}/generateHmac'.replaceAll('{' r'merchantId' '}', encodeQueryParameter(_serializers, merchantId, const FullType(String)).toString()).replaceAll('{' r'webhookId' '}', encodeQueryParameter(_serializers, webhookId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TestWebhookResponse>> postMerchantsMerchantIdWebhooksWebhookIdTest({ 
    required String merchantId,
    required String webhookId,
    ...
    final _path = r'/merchants/{merchantId}/webhooks/{webhookId}/test'.replaceAll('{' r'merchantId' '}', encodeQueryParameter(_serializers, merchantId, const FullType(String)).toString()).replaceAll('{' r'webhookId' '}', encodeQueryParameter(_serializers, webhookId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TestWebhookRequest);
      _bodyData = testWebhookRequest == null ? null : _serializers.serialize(testWebhookRequest, specifiedType: _type);
