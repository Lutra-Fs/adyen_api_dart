...
class AccountCompanyLevelApi {
  ...
  const AccountCompanyLevelApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ListCompanyResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListCompanyResponse>> getCompanies({ 
    int? pageNumber,
    int? pageSize,
    ...
    ListCompanyResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListCompanyResponse),
      ) as ListCompanyResponse;
    ...
    return Response<ListCompanyResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Company>> getCompaniesCompanyId({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListMerchantResponse>> getCompaniesCompanyIdMerchants({ 
    required String companyId,
    int? pageNumber,
    int? pageSize,
    CancelToken? cancelToken,
    ...
    final _path = r'/companies/{companyId}/merchants'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
