...
class APIKeyCompanyLevelApi {
  ...
  const APIKeyCompanyLevelApi(this._dio, this._serializers);
  ...
  Future<Response<GenerateApiKeyResponse>> postCompaniesCompanyIdApiCredentialsApiCredentialIdGenerateApiKey({ 
    ...
    final _path = r'/companies/{companyId}/apiCredentials/{apiCredentialId}/generateApiKey'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString()).replaceAll('{' r'apiCredentialId' '}', encodeQueryParameter(_serializers, apiCredentialId, const FullType(String)).toString());
