...
class TerminalSettingsCompanyLevelApi {
  ...
  const TerminalSettingsCompanyLevelApi(this._dio, this._serializers);
  ...
  Future<Response<Logo>> getCompaniesCompanyIdTerminalLogos({ 
    ...
    final _path = r'/companies/{companyId}/terminalLogos'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TerminalSettings>> getCompaniesCompanyIdTerminalSettings({ 
    required String companyId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/companies/{companyId}/terminalSettings'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Logo] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Logo>> patchCompaniesCompanyIdTerminalLogos({ 
    required String companyId,
    required String model,
    Logo? logo,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [TerminalSettings] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TerminalSettings>> patchCompaniesCompanyIdTerminalSettings({ 
    required String companyId,
