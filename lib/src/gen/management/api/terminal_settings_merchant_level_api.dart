...
class TerminalSettingsMerchantLevelApi {
  ...
  const TerminalSettingsMerchantLevelApi(this._dio, this._serializers);
  ...
  Future<Response<Logo>> getMerchantsMerchantIdTerminalLogos({ 
    ...
    final _path = r'/merchants/{merchantId}/terminalLogos'.replaceAll('{' r'merchantId' '}', encodeQueryParameter(_serializers, merchantId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TerminalSettings>> getMerchantsMerchantIdTerminalSettings({ 
    required String merchantId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/merchants/{merchantId}/terminalSettings'.replaceAll('{' r'merchantId' '}', encodeQueryParameter(_serializers, merchantId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Logo] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Logo>> patchMerchantsMerchantIdTerminalLogos({ 
    required String merchantId,
    required String model,
    Logo? logo,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [TerminalSettings] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TerminalSettings>> patchMerchantsMerchantIdTerminalSettings({ 
    required String merchantId,
