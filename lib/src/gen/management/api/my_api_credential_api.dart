...
class MyAPICredentialApi {
  ...
  const MyAPICredentialApi(this._dio, this._serializers);
  ...
  Future<Response<void>> deleteMeAllowedOriginsOriginId({ 
    ...
    final _path = r'/me/allowedOrigins/{originId}'.replaceAll('{' r'originId' '}', encodeQueryParameter(_serializers, originId, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MeApiCredential] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MeApiCredential>> getMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    MeApiCredential? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MeApiCredential),
      ) as MeApiCredential;
    ...
    return Response<MeApiCredential>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AllowedOriginsResponse>> getMeAllowedOrigins({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/me/allowedOrigins';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AllowedOrigin>> getMeAllowedOriginsOriginId({ 
    required String originId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [AllowedOrigin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AllowedOrigin>> postMeAllowedOrigins({ 
    ...
    try {
      const _type = FullType(CreateAllowedOriginRequest);
      _bodyData = createAllowedOriginRequest == null ? null : _serializers.serialize(createAllowedOriginRequest, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenerateClientKeyResponse>> postMeGenerateClientKey({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/me/generateClientKey';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
