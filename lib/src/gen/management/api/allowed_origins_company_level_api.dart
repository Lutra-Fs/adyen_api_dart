...
class AllowedOriginsCompanyLevelApi {
  ...
  const AllowedOriginsCompanyLevelApi(this._dio, this._serializers);
  ...
  Future<Response<void>> deleteCompaniesCompanyIdApiCredentialsApiCredentialIdAllowedOriginsOriginId({ 
    ...
    final _path = r'/companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins/{originId}'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString()).replaceAll('{' r'apiCredentialId' '}', encodeQueryParameter(_serializers, apiCredentialId, const FullType(String)).toString()).replaceAll('{' r'originId' '}', encodeQueryParameter(_serializers, originId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AllowedOriginsResponse>> getCompaniesCompanyIdApiCredentialsApiCredentialIdAllowedOrigins({ 
    required String companyId,
    required String apiCredentialId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString()).replaceAll('{' r'apiCredentialId' '}', encodeQueryParameter(_serializers, apiCredentialId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AllowedOrigin>> getCompaniesCompanyIdApiCredentialsApiCredentialIdAllowedOriginsOriginId({ 
    required String companyId,
    required String apiCredentialId,
    required String originId,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [AllowedOrigin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AllowedOrigin>> postCompaniesCompanyIdApiCredentialsApiCredentialIdAllowedOrigins({ 
    required String companyId,
    required String apiCredentialId,
