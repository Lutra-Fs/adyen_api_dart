...
part 'store_creation_with_merchant_code_request.g.dart';
...
@BuiltValue()
abstract class StoreCreationWithMerchantCodeRequest implements Built<StoreCreationWithMerchantCodeRequest, StoreCreationWithMerchantCodeRequestBuilder> {
  ...
  StoreCreationWithMerchantCodeRequest._();

  factory StoreCreationWithMerchantCodeRequest([void updates(StoreCreationWithMerchantCodeRequestBuilder b)]) = _$StoreCreationWithMerchantCodeRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StoreCreationWithMerchantCodeRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StoreCreationWithMerchantCodeRequest> get serializer => _$StoreCreationWithMerchantCodeRequestSerializer();
}

class _$StoreCreationWithMerchantCodeRequestSerializer implements PrimitiveSerializer<StoreCreationWithMerchantCodeRequest> {
  @override
  final Iterable<Type> types = const [StoreCreationWithMerchantCodeRequest, _$StoreCreationWithMerchantCodeRequest];

  @override
  final String wireName = r'StoreCreationWithMerchantCodeRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    StoreCreationWithMerchantCodeRequest object, {
  ...
  void _deserializeProperties(
    ...
    required StoreCreationWithMerchantCodeRequestBuilder result,
  ...
  @override
  StoreCreationWithMerchantCodeRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = StoreCreationWithMerchantCodeRequestBuilder();
