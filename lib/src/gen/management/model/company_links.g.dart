...
class _$CompanyLinks extends CompanyLinks {
  @override
  ...
  factory _$CompanyLinks([void Function(CompanyLinksBuilder)? updates]) =>
      (CompanyLinksBuilder()..update(updates))._build();
  ...
  @override
  CompanyLinks rebuild(void Function(CompanyLinksBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CompanyLinksBuilder toBuilder() => CompanyLinksBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CompanyLinks &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CompanyLinks')
...
class CompanyLinksBuilder
    implements Builder<CompanyLinks, CompanyLinksBuilder> {
  _$CompanyLinks? _$v;
  ...
  CompanyLinksBuilder() {
    CompanyLinks._defaults(this);
  }

  CompanyLinksBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(CompanyLinks other) {
    _$v = other as _$CompanyLinks;
  }

  @override
  void update(void Function(CompanyLinksBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  CompanyLinks build() => _build();

  _$CompanyLinks _build() {
    _$CompanyLinks _$result;
    try {
      _$result =
          _$v ??
          _$CompanyLinks._(
