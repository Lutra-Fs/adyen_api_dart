...
@BuiltValue()
abstract class ApiCredential implements Built<ApiCredential, ApiCredentialBuilder> {
  ...
  factory ApiCredential([void updates(ApiCredentialBuilder b)]) = _$ApiCredential;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApiCredentialBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApiCredential> get serializer => _$ApiCredentialSerializer();
}

class _$ApiCredentialSerializer implements PrimitiveSerializer<ApiCredential> {
  @override
  final Iterable<Type> types = const [ApiCredential, _$ApiCredential];

  @override
  final String wireName = r'ApiCredential';
  ...
  void _deserializeProperties(
    ...
    required ApiCredentialBuilder result,
  ...
  @override
  ApiCredential deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApiCredentialBuilder();
