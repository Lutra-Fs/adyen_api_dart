...
/// * [companyName] - Name of the company linked to the API credential.
...
@BuiltValue()
abstract class MeApiCredential implements Built<MeApiCredential, MeApiCredentialBuilder> {
  ...
  factory MeApiCredential([void updates(MeApiCredentialBuilder b)]) = _$MeApiCredential;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MeApiCredentialBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MeApiCredential> get serializer => _$MeApiCredentialSerializer();
}

class _$MeApiCredentialSerializer implements PrimitiveSerializer<MeApiCredential> {
  @override
  final Iterable<Type> types = const [MeApiCredential, _$MeApiCredential];

  @override
  final String wireName = r'MeApiCredential';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MeApiCredential object, {
  ...
  void _deserializeProperties(
    ...
    required MeApiCredentialBuilder result,
  ...
  @override
  MeApiCredential deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MeApiCredentialBuilder();
