...
part of 'store_creation_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$StoreCreationRequest extends StoreCreationRequest {
  @override
  ...
  factory _$StoreCreationRequest([
    void Function(StoreCreationRequestBuilder)? updates,
  ]) => (StoreCreationRequestBuilder()..update(updates))._build();

  _$StoreCreationRequest._({
  ...
  @override
  StoreCreationRequest rebuild(
    void Function(StoreCreationRequestBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  StoreCreationRequestBuilder toBuilder() =>
      StoreCreationRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is StoreCreationRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'StoreCreationRequest')
          ..add('address', address)
...
class StoreCreationRequestBuilder
    implements Builder<StoreCreationRequest, StoreCreationRequestBuilder> {
  _$StoreCreationRequest? _$v;
  ...
  StoreCreationRequestBuilder() {
    StoreCreationRequest._defaults(this);
  }

  StoreCreationRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(StoreCreationRequest other) {
    _$v = other as _$StoreCreationRequest;
  }

  @override
  void update(void Function(StoreCreationRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  StoreCreationRequest build() => _build();

  _$StoreCreationRequest _build() {
    _$StoreCreationRequest _$result;
    try {
      _$result =
          _$v ??
          _$StoreCreationRequest._(
