...
@BuiltValue()
abstract class StoreLocation implements Built<StoreLocation, StoreLocationBuilder> {
  ...
  static void _defaults(StoreLocationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StoreLocation> get serializer => _$StoreLocationSerializer();
}

class _$StoreLocationSerializer implements PrimitiveSerializer<StoreLocation> {
  @override
  final Iterable<Type> types = const [StoreLocation, _$StoreLocation];

  @override
  final String wireName = r'StoreLocation';
  ...
  void _deserializeProperties(
    ...
    required StoreLocationBuilder result,
  ...
  @override
  StoreLocation deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = StoreLocationBuilder();
