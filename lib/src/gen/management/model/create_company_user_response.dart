...
part 'create_company_user_response.g.dart';
...
@BuiltValue()
abstract class CreateCompanyUserResponse implements Built<CreateCompanyUserResponse, CreateCompanyUserResponseBuilder> {
  ...
  CreateCompanyUserResponse._();

  factory CreateCompanyUserResponse([void updates(CreateCompanyUserResponseBuilder b)]) = _$CreateCompanyUserResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateCompanyUserResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateCompanyUserResponse> get serializer => _$CreateCompanyUserResponseSerializer();
}

class _$CreateCompanyUserResponseSerializer implements PrimitiveSerializer<CreateCompanyUserResponse> {
  @override
  final Iterable<Type> types = const [CreateCompanyUserResponse, _$CreateCompanyUserResponse];

  @override
  final String wireName = r'CreateCompanyUserResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CreateCompanyUserResponse object, {
  ...
  void _deserializeProperties(
    ...
    required CreateCompanyUserResponseBuilder result,
  ...
  @override
  CreateCompanyUserResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreateCompanyUserResponseBuilder();
