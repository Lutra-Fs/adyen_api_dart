...
Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..add(MandateNotificationData.serializer)
          ..add(MandateNotificationRequest.serializer)
          ..add(MandateNotificationRequestTypeEnum.serializer)
          ..add(MandatePartyIdentification.serializer)
          ..add(MandateStatusEnum.serializer)
          ..add(MandateTypeEnum.serializer)
          ..add(Name.serializer)
          ...
          ..add(UKLocalMandateAccountIdentificationTypeEnum.serializer)
