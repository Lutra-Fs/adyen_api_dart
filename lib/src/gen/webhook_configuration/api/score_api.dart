...
class ScoreApi {
  ...
  const ScoreApi(this._dio, this._serializers);
  ...
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformScoreTriggered({ 
    ...
    final _path = r'/balancePlatform.score.triggered';
    ...
    try {
      const _type = FullType(ScoreNotificationRequest);
      _bodyData = scoreNotificationRequest == null ? null : _serializers.serialize(scoreNotificationRequest, specifiedType: _type);
