...
import '{import&#x3D;model.CardOrderNotificationRequest, classname&#x3D;CardOrderNotificationRequest}';
...
class CardOrderApi {
  ...
  const CardOrderApi(this._dio, this._serializers);
  ...
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformCardorderCreated({ 
    ...
    final _path = r'/balancePlatform.cardorder.created';
    ...
    try {
      const _type = FullType(CardOrderNotificationRequest);
      _bodyData = cardOrderNotificationRequest == null ? null : _serializers.serialize(cardOrderNotificationRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BalancePlatformNotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformCardorderUpdated({ 
    CardOrderNotificationRequest? cardOrderNotificationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/balancePlatform.cardorder.updated';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
