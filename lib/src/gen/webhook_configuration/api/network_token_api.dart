...
class NetworkTokenApi {
  ...
  const NetworkTokenApi(this._dio, this._serializers);
  ...
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformNetworkTokenCreated({ 
    ...
    final _path = r'/balancePlatform.networkToken.created';
    ...
    try {
      const _type = FullType(NetworkTokenNotificationRequest);
      _bodyData = networkTokenNotificationRequest == null ? null : _serializers.serialize(networkTokenNotificationRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BalancePlatformNotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformNetworkTokenUpdated({ 
    NetworkTokenNotificationRequest? networkTokenNotificationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/balancePlatform.networkToken.updated';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
