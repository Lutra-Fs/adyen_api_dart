...
import '{import&#x3D;model.PaymentNotificationRequest, classname&#x3D;PaymentNotificationRequest}';
...
class PaymentInstrumentApi {
  ...
  const PaymentInstrumentApi(this._dio, this._serializers);
  ...
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformPaymentInstrumentCreated({ 
    ...
    final _path = r'/balancePlatform.paymentInstrument.created';
    ...
    try {
      const _type = FullType(PaymentNotificationRequest);
      _bodyData = paymentNotificationRequest == null ? null : _serializers.serialize(paymentNotificationRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BalancePlatformNotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformPaymentInstrumentUpdated({ 
    PaymentNotificationRequest? paymentNotificationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/balancePlatform.paymentInstrument.updated';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
