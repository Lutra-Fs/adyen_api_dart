...
class BalanceAccountApi {

  final Dio _dio;

  final Serializers _serializers;

  const BalanceAccountApi(this._dio, this._serializers);
  ...
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformBalanceAccountCreated({ 
    ...
    final _path = r'/balancePlatform.balanceAccount.created';
    ...
    try {
      const _type = FullType(BalanceAccountNotificationRequest);
      _bodyData = balanceAccountNotificationRequest == null ? null : _serializers.serialize(balanceAccountNotificationRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BalancePlatformNotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformBalanceAccountSweepCreated({ 
    ...
    final _path = r'/balancePlatform.balanceAccountSweep.created';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SweepConfigurationNotificationRequest);
      _bodyData = sweepConfigurationNotificationRequest == null ? null : _serializers.serialize(sweepConfigurationNotificationRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BalancePlatformNotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformBalanceAccountSweepDeleted({ 
    SweepConfigurationNotificationRequest? sweepConfigurationNotificationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/balancePlatform.balanceAccountSweep.deleted';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BalancePlatformNotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformBalanceAccountSweepUpdated({ 
    SweepConfigurationNotificationRequest? sweepConfigurationNotificationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/balancePlatform.balanceAccountSweep.updated';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BalancePlatformNotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformBalanceAccountUpdated({ 
    BalanceAccountNotificationRequest? balanceAccountNotificationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/balancePlatform.balanceAccount.updated';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
