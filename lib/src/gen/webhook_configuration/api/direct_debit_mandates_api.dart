...
class DirectDebitMandatesApi {
  ...
  const DirectDebitMandatesApi(this._dio, this._serializers);
  ...
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformMandateCreated({ 
    ...
    final _path = r'/balancePlatform.mandate.created';
    ...
    try {
      const _type = FullType(MandateNotificationRequest);
      _bodyData = mandateNotificationRequest == null ? null : _serializers.serialize(mandateNotificationRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BalancePlatformNotificationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BalancePlatformNotificationResponse>> postBalancePlatformMandateUpdated({ 
    MandateNotificationRequest? mandateNotificationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/balancePlatform.mandate.updated';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
