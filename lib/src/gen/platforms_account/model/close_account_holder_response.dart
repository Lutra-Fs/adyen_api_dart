...
part 'close_account_holder_response.g.dart';
...
@BuiltValue()
abstract class CloseAccountHolderResponse implements Built<CloseAccountHolderResponse, CloseAccountHolderResponseBuilder> {
  ...
  CloseAccountHolderResponse._();

  factory CloseAccountHolderResponse([void updates(CloseAccountHolderResponseBuilder b)]) = _$CloseAccountHolderResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CloseAccountHolderResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CloseAccountHolderResponse> get serializer => _$CloseAccountHolderResponseSerializer();
}

class _$CloseAccountHolderResponseSerializer implements PrimitiveSerializer<CloseAccountHolderResponse> {
  @override
  final Iterable<Type> types = const [CloseAccountHolderResponse, _$CloseAccountHolderResponse];

  @override
  final String wireName = r'CloseAccountHolderResponse';
  ...
  void _deserializeProperties(
    ...
    required CloseAccountHolderResponseBuilder result,
  ...
  @override
  CloseAccountHolderResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CloseAccountHolderResponseBuilder();
