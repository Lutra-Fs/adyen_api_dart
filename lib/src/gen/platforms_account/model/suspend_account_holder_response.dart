...
part 'suspend_account_holder_response.g.dart';
...
@BuiltValue()
abstract class SuspendAccountHolderResponse implements Built<SuspendAccountHolderResponse, SuspendAccountHolderResponseBuilder> {
  ...
  SuspendAccountHolderResponse._();

  factory SuspendAccountHolderResponse([void updates(SuspendAccountHolderResponseBuilder b)]) = _$SuspendAccountHolderResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SuspendAccountHolderResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SuspendAccountHolderResponse> get serializer => _$SuspendAccountHolderResponseSerializer();
}

class _$SuspendAccountHolderResponseSerializer implements PrimitiveSerializer<SuspendAccountHolderResponse> {
  @override
  final Iterable<Type> types = const [SuspendAccountHolderResponse, _$SuspendAccountHolderResponse];

  @override
  final String wireName = r'SuspendAccountHolderResponse';
  ...
  void _deserializeProperties(
    ...
    required SuspendAccountHolderResponseBuilder result,
  ...
  @override
  SuspendAccountHolderResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SuspendAccountHolderResponseBuilder();
