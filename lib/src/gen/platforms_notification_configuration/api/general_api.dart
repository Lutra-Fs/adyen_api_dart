...
class GeneralApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetNotificationConfigurationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetNotificationConfigurationResponse>> postCreateNotificationConfiguration({ 
    ...
    final _path = r'/createNotificationConfiguration';
    ...
    try {
      const _type = FullType(CreateNotificationConfigurationRequest);
      _bodyData = createNotificationConfigurationRequest == null ? null : _serializers.serialize(createNotificationConfigurationRequest, specifiedType: _type);
    ...
    GetNotificationConfigurationResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetNotificationConfigurationResponse),
    ...
    return Response<GetNotificationConfigurationResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponse>> postDeleteNotificationConfigurations({ 
    ...
    final _path = r'/deleteNotificationConfigurations';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(DeleteNotificationConfigurationRequest);
      _bodyData = deleteNotificationConfigurationRequest == null ? null : _serializers.serialize(deleteNotificationConfigurationRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [GetNotificationConfigurationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetNotificationConfigurationResponse>> postGetNotificationConfiguration({ 
    ...
    final _path = r'/getNotificationConfiguration';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GetNotificationConfigurationRequest);
      _bodyData = getNotificationConfigurationRequest == null ? null : _serializers.serialize(getNotificationConfigurationRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetNotificationConfigurationListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetNotificationConfigurationListResponse>> postGetNotificationConfigurationList({ 
    JsonObject? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/getNotificationConfigurationList';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetNotificationConfigurationListResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetNotificationConfigurationListResponse),
      ) as GetNotificationConfigurationListResponse;
    ...
    return Response<GetNotificationConfigurationListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TestNotificationConfigurationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TestNotificationConfigurationResponse>> postTestNotificationConfiguration({ 
    ...
    final _path = r'/testNotificationConfiguration';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TestNotificationConfigurationRequest);
      _bodyData = testNotificationConfigurationRequest == null ? null : _serializers.serialize(testNotificationConfigurationRequest, specifiedType: _type);
    ...
    TestNotificationConfigurationResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TestNotificationConfigurationResponse),
      ) as TestNotificationConfigurationResponse;
    ...
    return Response<TestNotificationConfigurationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetNotificationConfigurationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetNotificationConfigurationResponse>> postUpdateNotificationConfiguration({ 
    ...
    final _path = r'/updateNotificationConfiguration';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpdateNotificationConfigurationRequest);
      _bodyData = updateNotificationConfigurationRequest == null ? null : _serializers.serialize(updateNotificationConfigurationRequest, specifiedType: _type);
