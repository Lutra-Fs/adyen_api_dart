...
part 'stored_value_void_response.g.dart';
...
@BuiltValue()
abstract class StoredValueVoidResponse implements Built<StoredValueVoidResponse, StoredValueVoidResponseBuilder> {
  ...
  StoredValueVoidResponseResultCodeEnum? get resultCode;
  ...
  StoredValueVoidResponse._();

  factory StoredValueVoidResponse([void updates(StoredValueVoidResponseBuilder b)]) = _$StoredValueVoidResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StoredValueVoidResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StoredValueVoidResponse> get serializer => _$StoredValueVoidResponseSerializer();
}

class _$StoredValueVoidResponseSerializer implements PrimitiveSerializer<StoredValueVoidResponse> {
  @override
  final Iterable<Type> types = const [StoredValueVoidResponse, _$StoredValueVoidResponse];

  @override
  final String wireName = r'StoredValueVoidResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    StoredValueVoidResponse object, {
    ...
    if (object.resultCode != null) {
      ...
      yield serializers.serialize(
        object.resultCode,
        specifiedType: const FullType(StoredValueVoidResponseResultCodeEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required StoredValueVoidResponseBuilder result,
      ...
      switch (key) {
        ...
        case r'resultCode':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(StoredValueVoidResponseResultCodeEnum),
          ) as StoredValueVoidResponseResultCodeEnum;
  ...
  @override
  StoredValueVoidResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = StoredValueVoidResponseBuilder();
...
class StoredValueVoidResponseResultCodeEnum extends EnumClass {

  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'Success')
  static const StoredValueVoidResponseResultCodeEnum success = _$storedValueVoidResponseResultCodeEnum_success;
  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'Refused')
  static const StoredValueVoidResponseResultCodeEnum refused = _$storedValueVoidResponseResultCodeEnum_refused;
  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'Error')
  static const StoredValueVoidResponseResultCodeEnum error = _$storedValueVoidResponseResultCodeEnum_error;
  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'NotEnoughBalance')
  static const StoredValueVoidResponseResultCodeEnum notEnoughBalance = _$storedValueVoidResponseResultCodeEnum_notEnoughBalance;
  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const StoredValueVoidResponseResultCodeEnum unknownDefaultOpenApi = _$storedValueVoidResponseResultCodeEnum_unknownDefaultOpenApi;

  static Serializer<StoredValueVoidResponseResultCodeEnum> get serializer => _$storedValueVoidResponseResultCodeEnumSerializer;

  const StoredValueVoidResponseResultCodeEnum._(String name): super(name);

  static BuiltSet<StoredValueVoidResponseResultCodeEnum> get values => _$storedValueVoidResponseResultCodeEnumValues;
  static StoredValueVoidResponseResultCodeEnum valueOf(String name) => _$storedValueVoidResponseResultCodeEnumValueOf(name);
}
