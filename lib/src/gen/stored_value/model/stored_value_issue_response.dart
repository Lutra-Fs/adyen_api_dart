...
part 'stored_value_issue_response.g.dart';
...
@BuiltValue()
abstract class StoredValueIssueResponse implements Built<StoredValueIssueResponse, StoredValueIssueResponseBuilder> {
  ...
  StoredValueIssueResponseResultCodeEnum? get resultCode;
  ...
  StoredValueIssueResponse._();

  factory StoredValueIssueResponse([void updates(StoredValueIssueResponseBuilder b)]) = _$StoredValueIssueResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StoredValueIssueResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StoredValueIssueResponse> get serializer => _$StoredValueIssueResponseSerializer();
}

class _$StoredValueIssueResponseSerializer implements PrimitiveSerializer<StoredValueIssueResponse> {
  @override
  final Iterable<Type> types = const [StoredValueIssueResponse, _$StoredValueIssueResponse];

  @override
  final String wireName = r'StoredValueIssueResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    StoredValueIssueResponse object, {
    ...
    if (object.resultCode != null) {
      ...
      yield serializers.serialize(
        object.resultCode,
        specifiedType: const FullType(StoredValueIssueResponseResultCodeEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required StoredValueIssueResponseBuilder result,
      ...
      switch (key) {
        ...
        case r'resultCode':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(StoredValueIssueResponseResultCodeEnum),
          ) as StoredValueIssueResponseResultCodeEnum;
  ...
  @override
  StoredValueIssueResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = StoredValueIssueResponseBuilder();
...
class StoredValueIssueResponseResultCodeEnum extends EnumClass {

  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'Success')
  static const StoredValueIssueResponseResultCodeEnum success = _$storedValueIssueResponseResultCodeEnum_success;
  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'Refused')
  static const StoredValueIssueResponseResultCodeEnum refused = _$storedValueIssueResponseResultCodeEnum_refused;
  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'Error')
  static const StoredValueIssueResponseResultCodeEnum error = _$storedValueIssueResponseResultCodeEnum_error;
  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'NotEnoughBalance')
  static const StoredValueIssueResponseResultCodeEnum notEnoughBalance = _$storedValueIssueResponseResultCodeEnum_notEnoughBalance;
  /// The result of the payment. Possible values:  * **Success** – The operation has been completed successfully.  * **Refused** – The operation was refused. The reason is given in the `refusalReason` field.  * **Error** – There was an error when the operation was processed. The reason is given in the `refusalReason` field.  * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.  
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const StoredValueIssueResponseResultCodeEnum unknownDefaultOpenApi = _$storedValueIssueResponseResultCodeEnum_unknownDefaultOpenApi;

  static Serializer<StoredValueIssueResponseResultCodeEnum> get serializer => _$storedValueIssueResponseResultCodeEnumSerializer;

  const StoredValueIssueResponseResultCodeEnum._(String name): super(name);

  static BuiltSet<StoredValueIssueResponseResultCodeEnum> get values => _$storedValueIssueResponseResultCodeEnumValues;
  static StoredValueIssueResponseResultCodeEnum valueOf(String name) => _$storedValueIssueResponseResultCodeEnumValueOf(name);
}
