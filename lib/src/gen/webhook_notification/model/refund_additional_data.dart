...
part 'refund_additional_data.g.dart';
...
/// * [store] 
@BuiltValue()
abstract class RefundAdditionalData implements Built<RefundAdditionalData, RefundAdditionalDataBuilder> {
  ...
  RefundAdditionalData._();

  factory RefundAdditionalData([void updates(RefundAdditionalDataBuilder b)]) = _$RefundAdditionalData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RefundAdditionalDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RefundAdditionalData> get serializer => _$RefundAdditionalDataSerializer();
}

class _$RefundAdditionalDataSerializer implements PrimitiveSerializer<RefundAdditionalData> {
  @override
  final Iterable<Type> types = const [RefundAdditionalData, _$RefundAdditionalData];

  @override
  final String wireName = r'RefundAdditionalData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RefundAdditionalData object, {
  ...
  void _deserializeProperties(
    ...
    required RefundAdditionalDataBuilder result,
  ...
  @override
  RefundAdditionalData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RefundAdditionalDataBuilder();
