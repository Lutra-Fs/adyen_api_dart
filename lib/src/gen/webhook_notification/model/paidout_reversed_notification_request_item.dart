...
part 'paidout_reversed_notification_request_item.g.dart';
...
@BuiltValue()
abstract class PaidoutReversedNotificationRequestItem implements Built<PaidoutReversedNotificationRequestItem, PaidoutReversedNotificationRequestItemBuilder> {
  ...
  PaidoutReversedNotificationRequestItem._();

  factory PaidoutReversedNotificationRequestItem([void updates(PaidoutReversedNotificationRequestItemBuilder b)]) = _$PaidoutReversedNotificationRequestItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaidoutReversedNotificationRequestItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaidoutReversedNotificationRequestItem> get serializer => _$PaidoutReversedNotificationRequestItemSerializer();
}

class _$PaidoutReversedNotificationRequestItemSerializer implements PrimitiveSerializer<PaidoutReversedNotificationRequestItem> {
  @override
  final Iterable<Type> types = const [PaidoutReversedNotificationRequestItem, _$PaidoutReversedNotificationRequestItem];

  @override
  final String wireName = r'PaidoutReversedNotificationRequestItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaidoutReversedNotificationRequestItem object, {
    ...
    yield serializers.serialize(
      object.eventCode,
      specifiedType: const FullType(PaidoutReversedNotificationRequestItemEventCodeEnum),
    );
    yield r'eventDate';
    yield serializers.serialize(
      object.eventDate,
  ...
  void _deserializeProperties(
    ...
    required PaidoutReversedNotificationRequestItemBuilder result,
      ...
      switch (key) {
        ...
        case r'eventCode':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PaidoutReversedNotificationRequestItemEventCodeEnum),
          ) as PaidoutReversedNotificationRequestItemEventCodeEnum;
  ...
  @override
  PaidoutReversedNotificationRequestItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaidoutReversedNotificationRequestItemBuilder();
...
class PaidoutReversedNotificationRequestItemEventCodeEnum extends EnumClass {

  /// The type of event the notification item is for.
  @BuiltValueEnumConst(wireName: r'PAIDOUT_REVERSED')
  static const PaidoutReversedNotificationRequestItemEventCodeEnum PAIDOUT_REVERSED = _$paidoutReversedNotificationRequestItemEventCodeEnum_PAIDOUT_REVERSED;
  /// The type of event the notification item is for.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const PaidoutReversedNotificationRequestItemEventCodeEnum unknownDefaultOpenApi = _$paidoutReversedNotificationRequestItemEventCodeEnum_unknownDefaultOpenApi;

  static Serializer<PaidoutReversedNotificationRequestItemEventCodeEnum> get serializer => _$paidoutReversedNotificationRequestItemEventCodeEnumSerializer;

  const PaidoutReversedNotificationRequestItemEventCodeEnum._(String name): super(name);

  static BuiltSet<PaidoutReversedNotificationRequestItemEventCodeEnum> get values => _$paidoutReversedNotificationRequestItemEventCodeEnumValues;
  static PaidoutReversedNotificationRequestItemEventCodeEnum valueOf(String name) => _$paidoutReversedNotificationRequestItemEventCodeEnumValueOf(name);
}
