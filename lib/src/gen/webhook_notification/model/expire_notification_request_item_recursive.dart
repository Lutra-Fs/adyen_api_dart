...
part 'expire_notification_request_item_recursive.g.dart';
...
/// * [success] - Always `true`.
@BuiltValue()
abstract class ExpireNotificationRequestItemRecursive implements Built<ExpireNotificationRequestItemRecursive, ExpireNotificationRequestItemRecursiveBuilder> {
  ...
  ExpireNotificationRequestItemRecursive._();

  factory ExpireNotificationRequestItemRecursive([void updates(ExpireNotificationRequestItemRecursiveBuilder b)]) = _$ExpireNotificationRequestItemRecursive;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ExpireNotificationRequestItemRecursiveBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ExpireNotificationRequestItemRecursive> get serializer => _$ExpireNotificationRequestItemRecursiveSerializer();
}

class _$ExpireNotificationRequestItemRecursiveSerializer implements PrimitiveSerializer<ExpireNotificationRequestItemRecursive> {
  @override
  final Iterable<Type> types = const [ExpireNotificationRequestItemRecursive, _$ExpireNotificationRequestItemRecursive];

  @override
  final String wireName = r'ExpireNotificationRequestItemRecursive';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ExpireNotificationRequestItemRecursive object, {
    ...
    yield serializers.serialize(
      object.eventCode,
      specifiedType: const FullType(ExpireNotificationRequestItemRecursiveEventCodeEnum),
    );
    yield r'eventDate';
    yield serializers.serialize(
      object.eventDate,
  ...
  void _deserializeProperties(
    ...
    required ExpireNotificationRequestItemRecursiveBuilder result,
      ...
      switch (key) {
        ...
        case r'eventCode':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ExpireNotificationRequestItemRecursiveEventCodeEnum),
          ) as ExpireNotificationRequestItemRecursiveEventCodeEnum;
  ...
  @override
  ExpireNotificationRequestItemRecursive deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ExpireNotificationRequestItemRecursiveBuilder();
...
class ExpireNotificationRequestItemRecursiveEventCodeEnum extends EnumClass {

  /// The type of event the notification item is for.
  @BuiltValueEnumConst(wireName: r'EXPIRE')
  static const ExpireNotificationRequestItemRecursiveEventCodeEnum EXPIRE = _$expireNotificationRequestItemRecursiveEventCodeEnum_EXPIRE;
  /// The type of event the notification item is for.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const ExpireNotificationRequestItemRecursiveEventCodeEnum unknownDefaultOpenApi = _$expireNotificationRequestItemRecursiveEventCodeEnum_unknownDefaultOpenApi;

  static Serializer<ExpireNotificationRequestItemRecursiveEventCodeEnum> get serializer => _$expireNotificationRequestItemRecursiveEventCodeEnumSerializer;

  const ExpireNotificationRequestItemRecursiveEventCodeEnum._(String name): super(name);

  static BuiltSet<ExpireNotificationRequestItemRecursiveEventCodeEnum> get values => _$expireNotificationRequestItemRecursiveEventCodeEnumValues;
  static ExpireNotificationRequestItemRecursiveEventCodeEnum valueOf(String name) => _$expireNotificationRequestItemRecursiveEventCodeEnumValueOf(name);
}
