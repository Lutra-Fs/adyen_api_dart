...
part 'recurring_contract_notification_request_item.g.dart';
...
@BuiltValue()
abstract class RecurringContractNotificationRequestItem implements Built<RecurringContractNotificationRequestItem, RecurringContractNotificationRequestItemBuilder> {
  ...
  RecurringContractNotificationRequestItem._();

  factory RecurringContractNotificationRequestItem([void updates(RecurringContractNotificationRequestItemBuilder b)]) = _$RecurringContractNotificationRequestItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RecurringContractNotificationRequestItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RecurringContractNotificationRequestItem> get serializer => _$RecurringContractNotificationRequestItemSerializer();
}

class _$RecurringContractNotificationRequestItemSerializer implements PrimitiveSerializer<RecurringContractNotificationRequestItem> {
  @override
  final Iterable<Type> types = const [RecurringContractNotificationRequestItem, _$RecurringContractNotificationRequestItem];

  @override
  final String wireName = r'RecurringContractNotificationRequestItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RecurringContractNotificationRequestItem object, {
    ...
    yield serializers.serialize(
      object.eventCode,
      specifiedType: const FullType(RecurringContractNotificationRequestItemEventCodeEnum),
    );
    yield r'eventDate';
    yield serializers.serialize(
      object.eventDate,
  ...
  void _deserializeProperties(
    ...
    required RecurringContractNotificationRequestItemBuilder result,
      ...
      switch (key) {
        ...
        case r'eventCode':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(RecurringContractNotificationRequestItemEventCodeEnum),
          ) as RecurringContractNotificationRequestItemEventCodeEnum;
  ...
  @override
  RecurringContractNotificationRequestItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RecurringContractNotificationRequestItemBuilder();
...
class RecurringContractNotificationRequestItemEventCodeEnum extends EnumClass {

  /// The type of event the notification item is for.
  @BuiltValueEnumConst(wireName: r'RECURRING_CONTRACT')
  static const RecurringContractNotificationRequestItemEventCodeEnum RECURRING_CONTRACT = _$recurringContractNotificationRequestItemEventCodeEnum_RECURRING_CONTRACT;
  /// The type of event the notification item is for.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const RecurringContractNotificationRequestItemEventCodeEnum unknownDefaultOpenApi = _$recurringContractNotificationRequestItemEventCodeEnum_unknownDefaultOpenApi;

  static Serializer<RecurringContractNotificationRequestItemEventCodeEnum> get serializer => _$recurringContractNotificationRequestItemEventCodeEnumSerializer;

  const RecurringContractNotificationRequestItemEventCodeEnum._(String name): super(name);

  static BuiltSet<RecurringContractNotificationRequestItemEventCodeEnum> get values => _$recurringContractNotificationRequestItemEventCodeEnumValues;
  static RecurringContractNotificationRequestItemEventCodeEnum valueOf(String name) => _$recurringContractNotificationRequestItemEventCodeEnumValueOf(name);
}
