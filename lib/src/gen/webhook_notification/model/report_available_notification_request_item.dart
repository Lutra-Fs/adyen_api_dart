...
part 'report_available_notification_request_item.g.dart';
...
/// * [success] - Always `true`.
@BuiltValue()
abstract class ReportAvailableNotificationRequestItem implements Built<ReportAvailableNotificationRequestItem, ReportAvailableNotificationRequestItemBuilder> {
  ...
  ReportAvailableNotificationRequestItem._();

  factory ReportAvailableNotificationRequestItem([void updates(ReportAvailableNotificationRequestItemBuilder b)]) = _$ReportAvailableNotificationRequestItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReportAvailableNotificationRequestItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReportAvailableNotificationRequestItem> get serializer => _$ReportAvailableNotificationRequestItemSerializer();
}

class _$ReportAvailableNotificationRequestItemSerializer implements PrimitiveSerializer<ReportAvailableNotificationRequestItem> {
  @override
  final Iterable<Type> types = const [ReportAvailableNotificationRequestItem, _$ReportAvailableNotificationRequestItem];

  @override
  final String wireName = r'ReportAvailableNotificationRequestItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ReportAvailableNotificationRequestItem object, {
    ...
    yield serializers.serialize(
      object.eventCode,
      specifiedType: const FullType(ReportAvailableNotificationRequestItemEventCodeEnum),
    );
    yield r'eventDate';
    yield serializers.serialize(
      object.eventDate,
  ...
  void _deserializeProperties(
    ...
    required ReportAvailableNotificationRequestItemBuilder result,
      ...
      switch (key) {
        ...
        case r'eventCode':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ReportAvailableNotificationRequestItemEventCodeEnum),
          ) as ReportAvailableNotificationRequestItemEventCodeEnum;
  ...
  @override
  ReportAvailableNotificationRequestItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ReportAvailableNotificationRequestItemBuilder();
...
class ReportAvailableNotificationRequestItemEventCodeEnum extends EnumClass {

  /// The type of event the notification item is for.
  @BuiltValueEnumConst(wireName: r'REPORT_AVAILABLE')
  static const ReportAvailableNotificationRequestItemEventCodeEnum REPORT_AVAILABLE = _$reportAvailableNotificationRequestItemEventCodeEnum_REPORT_AVAILABLE;
  /// The type of event the notification item is for.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const ReportAvailableNotificationRequestItemEventCodeEnum unknownDefaultOpenApi = _$reportAvailableNotificationRequestItemEventCodeEnum_unknownDefaultOpenApi;

  static Serializer<ReportAvailableNotificationRequestItemEventCodeEnum> get serializer => _$reportAvailableNotificationRequestItemEventCodeEnumSerializer;

  const ReportAvailableNotificationRequestItemEventCodeEnum._(String name): super(name);

  static BuiltSet<ReportAvailableNotificationRequestItemEventCodeEnum> get values => _$reportAvailableNotificationRequestItemEventCodeEnumValues;
  static ReportAvailableNotificationRequestItemEventCodeEnum valueOf(String name) => _$reportAvailableNotificationRequestItemEventCodeEnumValueOf(name);
}
