...
part 'get_pci_url_response.g.dart';
...
@BuiltValue()
abstract class GetPciUrlResponse implements Built<GetPciUrlResponse, GetPciUrlResponseBuilder> {
  ...
  factory GetPciUrlResponse([void updates(GetPciUrlResponseBuilder b)]) = _$GetPciUrlResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetPciUrlResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetPciUrlResponse> get serializer => _$GetPciUrlResponseSerializer();
}

class _$GetPciUrlResponseSerializer implements PrimitiveSerializer<GetPciUrlResponse> {
  @override
  final Iterable<Type> types = const [GetPciUrlResponse, _$GetPciUrlResponse];

  @override
  final String wireName = r'GetPciUrlResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GetPciUrlResponse object, {
  ...
  void _deserializeProperties(
    ...
    required GetPciUrlResponseBuilder result,
  ...
  @override
  GetPciUrlResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GetPciUrlResponseBuilder();
