...
class BankAccountValidationApi {
  ...
  const BankAccountValidationApi(this._dio, this._serializers);
  ...
  Future<Response<void>> postValidateBankAccountIdentification({ 
    ...
    final _path = r'/validateBankAccountIdentification';
    ...
    try {
      const _type = FullType(BankAccountIdentificationValidationRequest);
      _bodyData = bankAccountIdentificationValidationRequest == null ? null : _serializers.serialize(bankAccountIdentificationValidationRequest, specifiedType: _type);
