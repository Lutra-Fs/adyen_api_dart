...
class TransferLimitsBalanceAccountLevelApi {

  final Dio _dio;

  final Serializers _serializers;

  const TransferLimitsBalanceAccountLevelApi(this._dio, this._serializers);
  ...
  Future<Response<void>> deleteBalanceAccountsIdTransferLimitsTransferLimitId({ 
    required String id,
    ...
    final _path = r'/balanceAccounts/{id}/transferLimits/{transferLimitId}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'transferLimitId' '}', encodeQueryParameter(_serializers, transferLimitId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TransferLimitListResponse>> getBalanceAccountsIdTransferLimits({ 
    required String id,
    Scope? scope,
    ...
    final _path = r'/balanceAccounts/{id}/transferLimits'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [TransferLimitListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TransferLimitListResponse>> getBalanceAccountsIdTransferLimitsCurrent({ 
    required String id,
    Scope? scope,
    TransferType? transferType,
    CancelToken? cancelToken,
    ...
    final _path = r'/balanceAccounts/{id}/transferLimits/current'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TransferLimit>> getBalanceAccountsIdTransferLimitsTransferLimitId({ 
    required String id,
    required String transferLimitId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [TransferLimit] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TransferLimit>> postBalanceAccountsIdTransferLimits({ 
    required String id,
  ...
  /// * [wWWAuthenticate] - Header for authenticating using SCA.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postBalanceAccountsIdTransferLimitsApprove({ 
    required String id,
    required ApproveTransferLimitRequest approveTransferLimitRequest,
    String? wWWAuthenticate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/balanceAccounts/{id}/transferLimits/approve'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (wWWAuthenticate != null) r'WWW-Authenticate': wWWAuthenticate,
    ...
    try {
      const _type = FullType(ApproveTransferLimitRequest);
      _bodyData = _serializers.serialize(approveTransferLimitRequest, specifiedType: _type);
