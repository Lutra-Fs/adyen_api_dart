...
class DirectDebitMandatesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ListMandatesResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListMandatesResponse>> getMandates({ 
    ...
    ListMandatesResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListMandatesResponse),
      ) as ListMandatesResponse;
    ...
    return Response<ListMandatesResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Mandate>> getMandatesMandateId({ 
    ...
    final _path = r'/mandates/{mandateId}'.replaceAll('{' r'mandateId' '}', encodeQueryParameter(_serializers, mandateId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> patchMandatesMandateId({ 
    required String mandateId,
    required PatchableMandate patchableMandate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchableMandate);
      _bodyData = _serializers.serialize(patchableMandate, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postMandatesMandateIdCancel({ 
    required String mandateId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/mandates/{mandateId}/cancel'.replaceAll('{' r'mandateId' '}', encodeQueryParameter(_serializers, mandateId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
