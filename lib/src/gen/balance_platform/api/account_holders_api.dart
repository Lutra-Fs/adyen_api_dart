...
class AccountHoldersApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AccountHolder] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccountHolder>> getAccountHoldersId({ 
    required String id,
    ...
    final _path = r'/accountHolders/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PaginatedBalanceAccountsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedBalanceAccountsResponse>> getAccountHoldersIdBalanceAccounts({ 
    required String id,
    int? offset,
    int? limit,
    CancelToken? cancelToken,
    ...
    final _path = r'/accountHolders/{id}/balanceAccounts'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PaginatedBalanceAccountsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedBalanceAccountsResponse),
      ) as PaginatedBalanceAccountsResponse;
    ...
    return Response<PaginatedBalanceAccountsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetTaxFormResponse>> getAccountHoldersIdTaxForms({ 
    required String id,
    required String formType,
    required int year,
    ...
    final _path = r'/accountHolders/{id}/taxForms'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (legalEntityId != null) r'legalEntityId': encodeQueryParameter(_serializers, legalEntityId, const FullType(String)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TransactionRulesResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TransactionRulesResponse>> getAccountHoldersIdTransactionRules({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/accountHolders/{id}/transactionRules'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TransactionRulesResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TransactionRulesResponse),
      ) as TransactionRulesResponse;
    ...
    return Response<TransactionRulesResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [AccountHolder] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccountHolder>> patchAccountHoldersId({ 
    required String id,
    ...
    try {
      const _type = FullType(AccountHolderUpdateRequest);
      _bodyData = accountHolderUpdateRequest == null ? null : _serializers.serialize(accountHolderUpdateRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [AccountHolder] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccountHolder>> postAccountHolders({ 
    ...
    try {
      const _type = FullType(AccountHolderInfo);
      _bodyData = accountHolderInfo == null ? null : _serializers.serialize(accountHolderInfo, specifiedType: _type);
