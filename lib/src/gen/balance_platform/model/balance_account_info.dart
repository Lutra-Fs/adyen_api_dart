...
part 'balance_account_info.g.dart';
...
@BuiltValue()
abstract class BalanceAccountInfo implements Built<BalanceAccountInfo, BalanceAccountInfoBuilder> {
  ...
  BalanceAccountInfo._();

  factory BalanceAccountInfo([void updates(BalanceAccountInfoBuilder b)]) = _$BalanceAccountInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BalanceAccountInfoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BalanceAccountInfo> get serializer => _$BalanceAccountInfoSerializer();
}

class _$BalanceAccountInfoSerializer implements PrimitiveSerializer<BalanceAccountInfo> {
  @override
  final Iterable<Type> types = const [BalanceAccountInfo, _$BalanceAccountInfo];

  @override
  final String wireName = r'BalanceAccountInfo';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BalanceAccountInfo object, {
  ...
  void _deserializeProperties(
    ...
    required BalanceAccountInfoBuilder result,
  ...
  @override
  BalanceAccountInfo deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BalanceAccountInfoBuilder();
