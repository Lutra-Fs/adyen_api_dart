...
/// * [accountIdentification] - Contains the bank account details of the counterparty. The fields required in this object depend on the country of the bank account and the currency of the transfer.
@BuiltValue()
...
class _$MandateBankAccountSerializer implements PrimitiveSerializer<MandateBankAccount> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      ...
      specifiedType: const FullType(MandateAccountIdentification),
    );
  }
      ...
      switch (key) {
        ...
        case r'accountIdentification':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(MandateAccountIdentification),
          ) as MandateAccountIdentification;
          result.accountIdentification = valueDes;
          break;
        default:
          unhandled.add(key);
          unhandled.add(value);
