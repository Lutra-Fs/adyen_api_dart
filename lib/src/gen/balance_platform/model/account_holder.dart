...
@BuiltValue()
abstract class AccountHolder implements Built<AccountHolder, AccountHolderBuilder> {
  ...
  AccountHolderStatusEnum? get status;
  ...
  factory AccountHolder([void updates(AccountHolderBuilder b)]) = _$AccountHolder;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccountHolderBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountHolder> get serializer => _$AccountHolderSerializer();
}

class _$AccountHolderSerializer implements PrimitiveSerializer<AccountHolder> {
  @override
  final Iterable<Type> types = const [AccountHolder, _$AccountHolder];

  @override
  final String wireName = r'AccountHolder';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.status != null) {
      ...
      yield serializers.serialize(
        object.status,
        specifiedType: const FullType(AccountHolderStatusEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required AccountHolderBuilder result,
  ...
  @override
  AccountHolder deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountHolderBuilder();
...
class AccountHolderStatusEnum extends EnumClass {

  /// The status of the account holder.  Possible values:    * **active**: The account holder is active and allowed to use its capabilities. This is the initial status for account holders and balance accounts. You can change this status to **suspended** or **closed**.    * **suspended**: The account holder is temporarily disabled and payouts are blocked. You can change this status to **active** or **closed**.   * **closed**: The account holder and all of its capabilities are permanently disabled. This is a final status and cannot be changed.
  @BuiltValueEnumConst(wireName: r'active')
  static const AccountHolderStatusEnum active = _$accountHolderStatusEnum_active;
  /// The status of the account holder.  Possible values:    * **active**: The account holder is active and allowed to use its capabilities. This is the initial status for account holders and balance accounts. You can change this status to **suspended** or **closed**.    * **suspended**: The account holder is temporarily disabled and payouts are blocked. You can change this status to **active** or **closed**.   * **closed**: The account holder and all of its capabilities are permanently disabled. This is a final status and cannot be changed.
  @BuiltValueEnumConst(wireName: r'closed')
  static const AccountHolderStatusEnum closed = _$accountHolderStatusEnum_closed;
  /// The status of the account holder.  Possible values:    * **active**: The account holder is active and allowed to use its capabilities. This is the initial status for account holders and balance accounts. You can change this status to **suspended** or **closed**.    * **suspended**: The account holder is temporarily disabled and payouts are blocked. You can change this status to **active** or **closed**.   * **closed**: The account holder and all of its capabilities are permanently disabled. This is a final status and cannot be changed.
  @BuiltValueEnumConst(wireName: r'suspended')
  static const AccountHolderStatusEnum suspended = _$accountHolderStatusEnum_suspended;
  /// The status of the account holder.  Possible values:    * **active**: The account holder is active and allowed to use its capabilities. This is the initial status for account holders and balance accounts. You can change this status to **suspended** or **closed**.    * **suspended**: The account holder is temporarily disabled and payouts are blocked. You can change this status to **active** or **closed**.   * **closed**: The account holder and all of its capabilities are permanently disabled. This is a final status and cannot be changed.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const AccountHolderStatusEnum unknownDefaultOpenApi = _$accountHolderStatusEnum_unknownDefaultOpenApi;

  static Serializer<AccountHolderStatusEnum> get serializer => _$accountHolderStatusEnumSerializer;

  const AccountHolderStatusEnum._(String name): super(name);

  static BuiltSet<AccountHolderStatusEnum> get values => _$accountHolderStatusEnumValues;
  static AccountHolderStatusEnum valueOf(String name) => _$accountHolderStatusEnumValueOf(name);
}
