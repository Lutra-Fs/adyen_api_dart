...
Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..add(ApproveTransfersRequest.serializer)
          ...
          ..add(CancelTransfersRequest.serializer)
          ..add(CapitalBalance.serializer)
          ..add(CapitalGrant.serializer)
          ..add(CapitalGrantInfo.serializer)
          ..add(CapitalGrantStatusEnum.serializer)
          ..add(CapitalGrants.serializer)
          ..add(Card.serializer)
          ...
          ..add(CounterpartyInfoV3.serializer)
          ...
          ..add(Fee.serializer)
          ..add(FindTransfersResponse.serializer)
          ..add(FundingInstrument.serializer)
          ..add(FundingInstrumentSourceOfFundsEnum.serializer)
          ..add(GrantCounterparty.serializer)
          ..add(GrantInfoCounterparty.serializer)
          ...
          ..add(ReturnTransferRequest.serializer)
          ..add(ReturnTransferResponse.serializer)
          ..add(ReturnTransferResponseStatusEnum.serializer)
          ..add(RoutingDetails.serializer)
          ..add(RoutingDetailsPriorityEnum.serializer)
          ...
          ..add(TransactionSearchResponse.serializer)
          ..add(TransactionStatusEnum.serializer)
          ..add(Transfer.serializer)
          ..add(TransferCategoryData.serializer)
          ..add(TransferCategoryEnum.serializer)
          ...
          ..add(TransferDirectionEnum.serializer)
          ...
          ..add(TransferInfo.serializer)
          ..add(TransferInfoCategoryEnum.serializer)
          ..add(TransferInfoPrioritiesEnum.serializer)
          ..add(TransferInfoPriorityEnum.serializer)
          ..add(TransferInfoTypeEnum.serializer)
          ...
          ..add(TransferReasonEnum.serializer)
          ..add(TransferRequestReview.serializer)
          ..add(TransferReview.serializer)
          ..add(TransferReviewScaOnApprovalEnum.serializer)
          ..add(TransferServiceRestServiceError.serializer)
          ..add(TransferStatusEnum.serializer)
          ..add(TransferTypeEnum.serializer)
          ..add(TransferView.serializer)
          ...
          ..add(UltimatePartyIdentification.serializer)
          ..add(UltimatePartyIdentificationTypeEnum.serializer)
          ..addBuilderFactory(
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [const FullType(CapitalGrant)]),
            () => ListBuilder<CapitalGrant>(),
          )
          ..addBuilderFactory(
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [const FullType(RoutingDetails)]),
            () => ListBuilder<RoutingDetails>(),
          )
          ..addBuilderFactory(
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [const FullType(TransferData)]),
            () => ListBuilder<TransferData>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(TransferInfoPrioritiesEnum),
            ]),
            () => ListBuilder<TransferInfoPrioritiesEnum>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
